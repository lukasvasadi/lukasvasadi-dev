import { s as t1, n as fa } from './scheduler.ae1baad1.js'
import {
	S as r1,
	i as a1,
	g as V,
...
import { T as yn } from './tag.71a37a0c.js'
import { H as It } from './heading.44adad14.js'
class M0 {
	constructor(e, t, a) {
		;(this.lexer = void 0),
			(this.start = void 0),
...
class J0 {
	...
	range(e, t) {
		return new J0(t, M0.range(this, e))
	}
}
class z {
	constructor(e, t) {
		...
		if (o && o.start <= o.end) {
			...
			;(n = o.start),
				...
				n === h.length
					? (a += ' at end of input: ')
					: (a += ' at position ' + (n + 1) + ': ')
			var m = h.slice(n, l).replace(/[^]/g, '$&̲'),
				v
			n > 15 ? (v = '…' + h.slice(n - 15, n)) : (v = h.slice(0, n))
			var y
			l + 15 < h.length ? (y = h.slice(l, l + 15) + '…') : (y = h.slice(l)), (a += v + m + y)
		}
		var b = new Error(a)
		return (
			(b.name = 'ParseError'),
			(b.__proto__ = z.prototype),
			(b.position = n),
			n != null && l != null && (b.length = l - n),
			(b.rawMessage = e),
			b
		)
	}
...
var ms = function (e, t) {
	...
	vs = /[&><"']/g
function gs(r) {
	return String(r).replace(vs, (e) => fs[e])
}
var n1 = function r(e) {
...
class Aa {
	constructor(e) {
		;(this.displayMode = void 0),
			...
			(e = e || {})
		for (var t in Lr)
			if (Lr.hasOwnProperty(t)) {
				var a = Lr[t]
				this[t] = e[t] !== void 0 ? (a.processor ? a.processor(e[t]) : e[t]) : ws(a)
			}
	}
...
class fe {
	...
	sup() {
		return Z0[Bs[this.id]]
	}
	sub() {
		return Z0[ks[this.id]]
	}
	fracNum() {
		return Z0[Ss[this.id]]
	}
	fracDen() {
		return Z0[As[this.id]]
	}
	cramp() {
		return Z0[Ms[this.id]]
	}
	text() {
		return Z0[Ts[this.id]]
	}
	isTight() {
		return this.size >= 2
	}
...
var Ma = 0,
	...
	Bs = [Pt, L0, Pt, L0, ct, x0, ct, x0],
	ks = [L0, L0, L0, L0, x0, x0, x0, x0],
	Ss = [ht, le, Pt, L0, ct, x0, ct, x0],
	As = [le, le, L0, L0, x0, x0, x0, x0],
	Ms = [Pr, Pr, le, le, L0, L0, x0, x0],
	Ts = [Ma, Pr, ht, le, ht, le, ht, le],
	O = { DISPLAY: Z0[Ma], TEXT: Z0[ht], SCRIPT: Z0[Pt], SCRIPTSCRIPT: Z0[ct] },
	va = [
		{
			name: 'latin',
			blocks: [
...
function zs(r) {
	for (var e = 0; e < va.length; e++)
		for (var t = va[e], a = 0; a < t.blocks.length; a++) {
			var n = t.blocks[a]
...
var Or = []
va.forEach((r) => r.blocks.forEach((e) => Or.push(...e)))
function s1(r) {
	for (var e = 0; e < Or.length; e += 2) if (r >= Or[e] && r <= Or[e + 1]) return !0
	return !1
}
var ut = 80,
	Cs = function (e, t) {
...
function Ta(r, e, t) {
	...
	var a = r.charCodeAt(0),
		n = K0[e][a]
	if (
		(!n && r[0] in xn && ((a = xn[r[0]].charCodeAt(0)), (n = K0[e][a])),
		!n && t === 'text' && s1(a) && (n = K0[e][77]),
		n)
	)
...
function Ps(r) {
	var e
	if ((r >= 5 ? (e = 0) : r >= 3 ? (e = 1) : (e = 2), !ta[e])) {
		var t = (ta[e] = { cssEmPerMu: Cr.quad[e] / 18 })
		for (var a in Cr) Cr.hasOwnProperty(a) && (t[a] = Cr[a][e])
	}
	return ta[e]
}
var Gs = [
	...
	wn = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
	Bn = function (e, t) {
		return t.size < 2 ? e : Gs[e - 1][t.size - 1]
	}
class se {
	constructor(e) {
		;(this.style = void 0),
			...
			(this.sizeMultiplier = wn[this.size - 1]),
	...
	havingStyle(e) {
		return this.style === e ? this : this.extend({ style: e, size: Bn(this.textSize, e) })
	}
	havingCrampedStyle() {
	...
	havingSize(e) {
		return this.size === e && this.textSize === e
			...
			: this.extend({
					...
					size: e,
					textSize: e,
					sizeMultiplier: wn[e - 1]
			  })
	}
	havingBaseStyle(e) {
		e = e || this.style.text()
		var t = Bn(se.BASESIZE, e)
		return this.size === t && this.textSize === se.BASESIZE && this.style === e
			? this
	...
	baseSizingClasses() {
		return this.size !== se.BASESIZE
			? ['sizing', 'reset-size' + this.size, 'size' + se.BASESIZE]
			: []
	}
	fontMetrics() {
		return this._fontMetrics || (this._fontMetrics = Ps(this.size)), this._fontMetrics
	}
	getColor() {
...
var ga = {
	...
	$s = { ex: !0, em: !0, mu: !0 },
	l1 = function (e) {
		return typeof e != 'string' && (e = e.unit), e in ga || e in $s || e === 'ex'
	},
	l0 = function (e, t) {
		var a
		if (e.unit in ga) a = ga[e.unit] / t.fontMetrics().ptPerEm / t.sizeMultiplier
		else if (e.unit === 'mu') a = t.fontMetrics().cssEmPerMu
		else {
			var n
			if (
				(t.style.isTight() ? (n = t.havingStyle(t.style.text())) : (n = t), e.unit === 'ex')
			)
	...
	u1 = function (e) {
		var t = '<' + e
		this.classes.length && (t += ' class="' + $.escape(ye(this.classes)) + '"')
		var a = ''
		for (var n in this.style)
			this.style.hasOwnProperty(n) && (a += $.hyphenate(n) + ':' + this.style[n] + ';')
		a && (t += ' style="' + $.escape(a) + '"')
		for (var l in this.attributes)
			this.attributes.hasOwnProperty(l) &&
...
class Us {
	...
	toMarkup() {
		...
		for (var a in this.style)
			this.style.hasOwnProperty(a) && (t += $.hyphenate(a) + ':' + this.style[a] + ';')
		return t && (e += ' style="' + $.escape(t) + '"'), (e += "'/>"), e
	}
}
var Vs = { î: 'ı̂', ï: 'ı̈', í: 'ı́', ì: 'ı̀' }
class O0 {
	constructor(e, t, a, n, l, o, h, m) {
		;(this.text = void 0),
			...
			(this.style = m || {}),
			(this.maxFontSize = 0)
		var v = zs(this.text.charCodeAt(0))
		v && this.classes.push(v + '_fallback'),
			/[îïíì]/.test(this.text) && (this.text = Vs[this.text])
	}
	hasClass(e) {
		return $.contains(this.classes, e)
	}
	toNode() {
		var e = document.createTextNode(this.text),
			t = null
		this.italic > 0 &&
			((t = document.createElement('span')), (t.style.marginRight = F(this.italic))),
			this.classes.length > 0 &&
				((t = t || document.createElement('span')), (t.className = ye(this.classes)))
		for (var a in this.style)
	...
	toMarkup() {
		var e = !1,
			t = '<span'
		this.classes.length &&
			((e = !0), (t += ' class="'), (t += $.escape(ye(this.classes))), (t += '"'))
		var a = ''
		this.italic > 0 && (a += 'margin-right:' + this.italic + 'em;')
		for (var n in this.style)
			this.style.hasOwnProperty(n) && (a += $.hyphenate(n) + ':' + this.style[n] + ';')
		a && ((e = !0), (t += ' style="' + $.escape(a) + '"'))
	...
	toNode() {
		...
		return (
			this.alternate
				...
				: t.setAttribute('d', bn[this.pathName]),
			t
		)
	}
	toMarkup() {
...
function kn(r) {
	if (r instanceof O0) return r
	throw new Error('Expected symbolNode but got ' + String(r) + '.')
}
function _s(r) {
	if (r instanceof Vt) return r
	throw new Error('Expected span<HtmlDomNode> but got ' + String(r) + '.')
}
var Ws = { bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1 },
	Xs = { 'accent-token': 1, mathord: 1, 'op-token': 1, spacing: 1, textord: 1 },
	r0 = { math: {}, text: {} }
function s(r, e, t, a, n, l) {
	;(r0[r][n] = { font: e, group: t, replace: a }), l && a && (r0[r][a] = r0[r][n])
}
var i = 'math',
	M = 'text',
	u = 'main',
...
s(i, u, f, '⋈', '\\bowtie', !0)
s(i, u, f, '⌣', '\\smile', !0)
s(i, u, f, '⊑', '\\sqsubseteq', !0)
s(i, u, f, '⊒', '\\sqsupseteq', !0)
s(i, u, f, '≐', '\\doteq', !0)
s(i, u, f, '⌢', '\\frown', !0)
s(i, u, f, '∋', '\\ni', !0)
s(i, u, f, '∝', '\\propto', !0)
...
s(i, u, g, '‡', '\\ddag')
s(M, u, g, '‡', '\\ddag')
s(M, u, g, '‡', '\\textdaggerdbl')
s(i, u, w0, '⎱', '\\rmoustache', !0)
s(i, u, T0, '⎰', '\\lmoustache', !0)
s(i, u, w0, '⟯', '\\rgroup', !0)
s(i, u, T0, '⟮', '\\lgroup', !0)
s(i, u, q, '∓', '\\mp', !0)
s(i, u, q, '⊖', '\\ominus', !0)
...
s(i, u, q, '⨿', '\\amalg')
s(i, u, q, '&', '\\And')
s(i, u, f, '⟵', '\\longleftarrow', !0)
s(i, u, f, '⇐', '\\Leftarrow', !0)
s(i, u, f, '⟸', '\\Longleftarrow', !0)
s(i, u, f, '⟶', '\\longrightarrow', !0)
s(i, u, f, '⇒', '\\Rightarrow', !0)
s(i, u, f, '⟹', '\\Longrightarrow', !0)
s(i, u, f, '↔', '\\leftrightarrow', !0)
s(i, u, f, '⟷', '\\longleftrightarrow', !0)
s(i, u, f, '⇔', '\\Leftrightarrow', !0)
s(i, u, f, '⟺', '\\Longleftrightarrow', !0)
s(i, u, f, '↦', '\\mapsto', !0)
s(i, u, f, '⟼', '\\longmapsto', !0)
s(i, u, f, '↗', '\\nearrow', !0)
s(i, u, f, '↩', '\\hookleftarrow', !0)
s(i, u, f, '↪', '\\hookrightarrow', !0)
s(i, u, f, '↘', '\\searrow', !0)
s(i, u, f, '↼', '\\leftharpoonup', !0)
s(i, u, f, '⇀', '\\rightharpoonup', !0)
s(i, u, f, '↙', '\\swarrow', !0)
s(i, u, f, '↽', '\\leftharpoondown', !0)
s(i, u, f, '⇁', '\\rightharpoondown', !0)
s(i, u, f, '↖', '\\nwarrow', !0)
s(i, u, f, '⇌', '\\rightleftharpoons', !0)
s(i, d, f, '≮', '\\nless', !0)
s(i, d, f, '', '\\@nleqslant')
s(i, d, f, '', '\\@nleqq')
s(i, d, f, '⪇', '\\lneq', !0)
...
s(i, d, f, '⋬', '\\ntrianglelefteq', !0)
s(i, d, f, '⊊', '\\subsetneq', !0)
s(i, d, f, '', '\\@varsubsetneq')
s(i, d, f, '⫋', '\\subsetneqq', !0)
s(i, d, f, '', '\\@varsubsetneqq')
s(i, d, f, '≯', '\\ngtr', !0)
s(i, d, f, '', '\\@ngeqslant')
s(i, d, f, '', '\\@ngeqq')
s(i, d, f, '⪈', '\\gneq', !0)
...
s(i, d, f, '⋡', '\\nsucceq', !0)
s(i, d, f, '⋩', '\\succnsim', !0)
s(i, d, f, '⪺', '\\succnapprox', !0)
s(i, d, f, '≆', '\\ncong', !0)
s(i, d, f, '', '\\@nshortparallel')
s(i, d, f, '∦', '\\nparallel', !0)
s(i, d, f, '⊯', '\\nVDash', !0)
s(i, d, f, '⋫', '\\ntriangleright')
s(i, d, f, '⋭', '\\ntrianglerighteq', !0)
s(i, d, f, '', '\\@nsupseteqq')
s(i, d, f, '⊋', '\\supsetneq', !0)
s(i, d, f, '', '\\@varsupsetneq')
s(i, d, f, '⫌', '\\supsetneqq', !0)
s(i, d, f, '', '\\@varsupsetneqq')
s(i, d, f, '⊮', '\\nVdash', !0)
s(i, d, f, '⪵', '\\precneqq', !0)
s(i, d, f, '⪶', '\\succneqq', !0)
s(i, d, f, '', '\\@nsubseteqq')
...
s(i, d, g, '®', '\\circledR')
s(M, d, g, '®', '\\circledR')
s(i, d, g, '∡', '\\measuredangle', !0)
s(i, d, g, '∄', '\\nexists')
s(i, d, g, '℧', '\\mho')
s(i, d, g, 'Ⅎ', '\\Finv', !0)
s(i, d, g, '⅁', '\\Game', !0)
s(i, d, g, '‵', '\\backprime')
s(i, d, g, '▲', '\\blacktriangle')
s(i, d, g, '▼', '\\blacktriangledown')
s(i, d, g, '■', '\\blacksquare')
s(i, d, g, '⧫', '\\blacklozenge')
s(i, d, g, '★', '\\bigstar')
s(i, d, g, '∢', '\\sphericalangle', !0)
s(i, d, g, '∁', '\\complement', !0)
s(i, d, g, 'ð', '\\eth', !0)
s(M, u, g, 'ð', 'ð')
s(i, d, g, '╱', '\\diagup')
s(i, d, g, '╲', '\\diagdown')
...
s(i, d, f, '≦', '\\leqq', !0)
s(i, d, f, '⩽', '\\leqslant', !0)
s(i, d, f, '⪕', '\\eqslantless', !0)
s(i, d, f, '≲', '\\lesssim', !0)
s(i, d, f, '⪅', '\\lessapprox', !0)
s(i, d, f, '≊', '\\approxeq', !0)
s(i, d, q, '⋖', '\\lessdot')
s(i, d, f, '⋘', '\\lll', !0)
s(i, d, f, '≶', '\\lessgtr', !0)
s(i, d, f, '⋚', '\\lesseqgtr', !0)
s(i, d, f, '⪋', '\\lesseqqgtr', !0)
s(i, d, f, '≑', '\\doteqdot')
s(i, d, f, '≓', '\\risingdotseq', !0)
s(i, d, f, '≒', '\\fallingdotseq', !0)
s(i, d, f, '∽', '\\backsim', !0)
s(i, d, f, '⋍', '\\backsimeq', !0)
s(i, d, f, '⫅', '\\subseteqq', !0)
s(i, d, f, '⋐', '\\Subset', !0)
s(i, d, f, '⊏', '\\sqsubset', !0)
s(i, d, f, '≼', '\\preccurlyeq', !0)
s(i, d, f, '⋞', '\\curlyeqprec', !0)
s(i, d, f, '≾', '\\precsim', !0)
s(i, d, f, '⪷', '\\precapprox', !0)
s(i, d, f, '⊲', '\\vartriangleleft')
s(i, d, f, '⊴', '\\trianglelefteq')
s(i, d, f, '⊨', '\\vDash', !0)
s(i, d, f, '⊪', '\\Vvdash', !0)
s(i, d, f, '⌣', '\\smallsmile')
s(i, d, f, '⌢', '\\smallfrown')
...
s(i, d, f, '⋑', '\\Supset', !0)
s(i, d, f, '⊐', '\\sqsupset', !0)
s(i, d, f, '≽', '\\succcurlyeq', !0)
s(i, d, f, '⋟', '\\curlyeqsucc', !0)
s(i, d, f, '≿', '\\succsim', !0)
s(i, d, f, '⪸', '\\succapprox', !0)
s(i, d, f, '⊳', '\\vartriangleright')
s(i, d, f, '⊵', '\\trianglerighteq')
s(i, d, f, '⊩', '\\Vdash', !0)
s(i, d, f, '∣', '\\shortmid')
s(i, d, f, '∥', '\\shortparallel')
s(i, d, f, '≬', '\\between', !0)
s(i, d, f, '⋔', '\\pitchfork', !0)
s(i, d, f, '∝', '\\varpropto')
s(i, d, f, '◀', '\\blacktriangleleft')
s(i, d, f, '∴', '\\therefore', !0)
s(i, d, f, '∍', '\\backepsilon')
s(i, d, f, '▶', '\\blacktriangleright')
s(i, d, f, '∵', '\\because', !0)
s(i, d, f, '⋘', '\\llless')
s(i, d, f, '⋙', '\\gggtr')
s(i, d, q, '⊲', '\\lhd')
...
s(i, d, f, '≑', '\\Doteq', !0)
s(i, d, q, '∔', '\\dotplus', !0)
s(i, d, q, '∖', '\\smallsetminus')
s(i, d, q, '⋒', '\\Cap', !0)
s(i, d, q, '⋓', '\\Cup', !0)
s(i, d, q, '⩞', '\\doublebarwedge', !0)
s(i, d, q, '⊟', '\\boxminus', !0)
s(i, d, q, '⊞', '\\boxplus', !0)
s(i, d, q, '⋇', '\\divideontimes', !0)
s(i, d, q, '⋉', '\\ltimes', !0)
s(i, d, q, '⋊', '\\rtimes', !0)
s(i, d, q, '⋋', '\\leftthreetimes', !0)
s(i, d, q, '⋌', '\\rightthreetimes', !0)
s(i, d, q, '⋏', '\\curlywedge', !0)
s(i, d, q, '⋎', '\\curlyvee', !0)
s(i, d, q, '⊝', '\\circleddash', !0)
s(i, d, q, '⊛', '\\circledast', !0)
s(i, d, q, '⋅', '\\centerdot')
s(i, d, q, '⊺', '\\intercal', !0)
s(i, d, q, '⋒', '\\doublecap')
s(i, d, q, '⋓', '\\doublecup')
s(i, d, q, '⊠', '\\boxtimes', !0)
s(i, d, f, '⇢', '\\dashrightarrow', !0)
s(i, d, f, '⇠', '\\dashleftarrow', !0)
s(i, d, f, '⇇', '\\leftleftarrows', !0)
s(i, d, f, '⇆', '\\leftrightarrows', !0)
s(i, d, f, '⇚', '\\Lleftarrow', !0)
s(i, d, f, '↞', '\\twoheadleftarrow', !0)
s(i, d, f, '↢', '\\leftarrowtail', !0)
s(i, d, f, '↫', '\\looparrowleft', !0)
s(i, d, f, '⇋', '\\leftrightharpoons', !0)
s(i, d, f, '↶', '\\curvearrowleft', !0)
s(i, d, f, '↺', '\\circlearrowleft', !0)
s(i, d, f, '↰', '\\Lsh', !0)
s(i, d, f, '⇈', '\\upuparrows', !0)
s(i, d, f, '↿', '\\upharpoonleft', !0)
s(i, d, f, '⇃', '\\downharpoonleft', !0)
s(i, u, f, '⊶', '\\origof', !0)
s(i, u, f, '⊷', '\\imageof', !0)
s(i, d, f, '⊸', '\\multimap', !0)
s(i, d, f, '↭', '\\leftrightsquigarrow', !0)
s(i, d, f, '⇉', '\\rightrightarrows', !0)
s(i, d, f, '⇄', '\\rightleftarrows', !0)
s(i, d, f, '↠', '\\twoheadrightarrow', !0)
s(i, d, f, '↣', '\\rightarrowtail', !0)
s(i, d, f, '↬', '\\looparrowright', !0)
s(i, d, f, '↷', '\\curvearrowright', !0)
s(i, d, f, '↻', '\\circlearrowright', !0)
s(i, d, f, '↱', '\\Rsh', !0)
s(i, d, f, '⇊', '\\downdownarrows', !0)
s(i, d, f, '↾', '\\upharpoonright', !0)
s(i, d, f, '⇂', '\\downharpoonright', !0)
s(i, d, f, '⇝', '\\rightsquigarrow', !0)
s(i, d, f, '⇝', '\\leadsto')
s(i, d, f, '⇛', '\\Rrightarrow', !0)
s(i, d, f, '↾', '\\restriction')
s(i, u, g, '‘', '`')
s(i, u, g, '$', '\\$')
s(M, u, g, '$', '\\$')
...
s(i, u, L, 'ψ', '\\psi', !0)
s(i, u, L, 'ω', '\\omega', !0)
s(i, u, L, 'ε', '\\varepsilon', !0)
s(i, u, L, 'ϑ', '\\vartheta', !0)
s(i, u, L, 'ϖ', '\\varpi', !0)
s(i, u, L, 'ϱ', '\\varrho', !0)
s(i, u, L, 'ς', '\\varsigma', !0)
s(i, u, L, 'φ', '\\varphi', !0)
s(i, u, q, '∗', '*', !0)
s(i, u, q, '+', '+')
s(i, u, q, '−', '-', !0)
...
s(i, u, g, '∂', '\\partial', !0)
s(i, u, q, '⊘', '\\oslash', !0)
s(i, d, q, '⊚', '\\circledcirc', !0)
s(i, d, q, '⊡', '\\boxdot', !0)
s(i, u, q, '△', '\\bigtriangleup')
s(i, u, q, '▽', '\\bigtriangledown')
s(i, u, q, '†', '\\dagger')
s(i, u, q, '⋄', '\\diamond')
s(i, u, q, '⋆', '\\star')
s(i, u, q, '◃', '\\triangleleft')
s(i, u, q, '▹', '\\triangleright')
s(i, u, T0, '{', '\\{')
s(M, u, g, '{', '\\{')
s(M, u, g, '{', '\\textbraceleft')
s(i, u, w0, '}', '\\}')
s(M, u, g, '}', '\\}')
s(M, u, g, '}', '\\textbraceright')
s(i, u, T0, '{', '\\lbrace')
s(i, u, w0, '}', '\\rbrace')
s(i, u, T0, '[', '\\lbrack', !0)
s(M, u, g, '[', '\\lbrack', !0)
...
s(i, u, g, '∥', '\\Vert')
s(M, u, g, '∥', '\\textbardbl')
s(M, u, g, '~', '\\textasciitilde')
s(M, u, g, '\\', '\\textbackslash')
s(M, u, g, '^', '\\textasciicircum')
s(i, u, f, '↑', '\\uparrow', !0)
s(i, u, f, '⇑', '\\Uparrow', !0)
s(i, u, f, '↓', '\\downarrow', !0)
s(i, u, f, '⇓', '\\Downarrow', !0)
s(i, u, f, '↕', '\\updownarrow', !0)
s(i, u, f, '⇕', '\\Updownarrow', !0)
s(i, u, u0, '∐', '\\coprod')
s(i, u, u0, '⋁', '\\bigvee')
s(i, u, u0, '⋀', '\\bigwedge')
...
s(i, u, u0, '⨆', '\\bigsqcup')
s(i, u, u0, '∫', '\\smallint')
s(M, u, pt, '…', '\\textellipsis')
s(i, u, pt, '…', '\\mathellipsis')
s(M, u, pt, '…', '\\ldots', !0)
s(i, u, pt, '…', '\\ldots', !0)
s(i, u, pt, '⋯', '\\@cdots', !0)
s(i, u, pt, '⋱', '\\ddots', !0)
...
s(M, u, g, '—', '\\textemdash')
s(M, u, g, '‘', '`', !0)
s(M, u, g, '‘', '\\textquoteleft')
s(M, u, g, '’', "'", !0)
s(M, u, g, '’', '\\textquoteright')
s(M, u, g, '“', '``', !0)
s(M, u, g, '“', '\\textquotedblleft')
s(M, u, g, '”', "''", !0)
s(M, u, g, '”', '\\textquotedblright')
s(i, u, g, '°', '\\degree', !0)
s(M, u, g, '°', '\\degree')
s(M, u, g, '°', '\\textdegree', !0)
s(i, u, g, '£', '\\pounds')
s(i, u, g, '£', '\\mathsterling', !0)
s(M, u, g, '£', '\\pounds')
s(M, u, g, '£', '\\textsterling', !0)
s(i, d, g, '✠', '\\maltese')
s(M, d, g, '✠', '\\maltese')
var Sn = '0123456789/@."'
...
var Mn = '0123456789!@*()-=+";:?/.,'
for (var aa = 0; aa < Mn.length; aa++) {
	var Tn = Mn.charAt(aa)
	s(M, u, g, Tn, Tn)
}
var Gr = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'
for (var na = 0; na < Gr.length; na++) {
	var Dr = Gr.charAt(na)
	s(i, u, L, Dr, Dr), s(M, u, g, Dr, Dr)
}
s(i, d, g, 'C', 'ℂ')
s(M, d, g, 'C', 'ℂ')
s(i, d, g, 'H', 'ℍ')
...
s(M, u, L, 'h', 'ℎ')
var G = ''
for (var b0 = 0; b0 < Gr.length; b0++) {
	var i0 = Gr.charAt(b0)
	;(G = String.fromCharCode(55349, 56320 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56372 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56424 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56580 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56684 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56736 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56788 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56840 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		(G = String.fromCharCode(55349, 56944 + b0)),
		s(i, u, L, i0, G),
		s(M, u, g, i0, G),
		b0 < 26 &&
			((G = String.fromCharCode(55349, 56632 + b0)),
			s(i, u, L, i0, G),
			s(M, u, g, i0, G),
			(G = String.fromCharCode(55349, 56476 + b0)),
			s(i, u, L, i0, G),
			s(M, u, g, i0, G))
}
G = String.fromCharCode(55349, 56668)
s(i, u, L, 'k', G)
s(M, u, g, 'k', G)
for (var nt = 0; nt < 10; nt++) {
	var ve = nt.toString()
	;(G = String.fromCharCode(55349, 57294 + nt)),
		s(i, u, L, ve, G),
		s(M, u, g, ve, G),
		(G = String.fromCharCode(55349, 57314 + nt)),
		s(i, u, L, ve, G),
		s(M, u, g, ve, G),
		(G = String.fromCharCode(55349, 57324 + nt)),
		s(i, u, L, ve, G),
		s(M, u, g, ve, G),
		(G = String.fromCharCode(55349, 57334 + nt)),
		s(i, u, L, ve, G),
		s(M, u, g, ve, G)
}
var ba = 'ÐÞþ'
for (var sa = 0; sa < ba.length; sa++) {
	var Fr = ba.charAt(sa)
	s(i, u, L, Fr, Fr), s(M, u, g, Fr, Fr)
}
var Er = [
	...
	Ys = function (e, t) {
		var a = e.charCodeAt(0),
			n = e.charCodeAt(1),
			l = (a - 55296) * 1024 + (n - 56320) + 65536,
			o = t === 'math' ? 0 : 1
		if (119808 <= l && l < 120484) {
			var h = Math.floor((l - 119808) / 26)
			return [Er[h][2], Er[h][o]]
		} else if (120782 <= l && l <= 120831) {
			var m = Math.floor((l - 120782) / 10)
			return [zn[m][2], zn[m][o]]
		} else {
			if (l === 120485 || l === 120486) return [Er[0][2], Er[0][o]]
	...
	Wr = function (e, t, a) {
		return (
			r0[a][e] && r0[a][e].replace && (e = r0[a][e].replace),
			{ value: e, metrics: Ta(e, t, a) }
		)
	},
	X0 = function (e, t, a, n, l) {
		var o = Wr(e, t, a),
			h = o.metrics
		e = o.value
		var m
		if (h) {
			...
			;(a === 'text' || (n && n.font === 'mathit')) && (v = 0),
				(m = new O0(e, h.height, h.depth, v, h.skew, h.width, l))
		} else
			typeof console < 'u' &&
				console.warn(
	...
	js = function (e, t, a, n) {
		return (
			n === void 0 && (n = []),
			a.font === 'boldsymbol' && Wr(e, 'Main-Bold', t).metrics
	...
	Zs = function (e, t, a, n, l) {
		return l !== 'textord' && Wr(e, 'Math-BoldItalic', t).metrics
	...
	Ks = function (e, t, a) {
		var n = e.mode,
			...
			v = '',
			y = ''
		if ((l.charCodeAt(0) === 55349 && ([v, y] = Ys(l, n)), v.length > 0))
			return X0(l, v, n, t, o.concat(y))
		if (m) {
			var b, B
			if (m === 'boldsymbol') {
				var k = Zs(l, n, t, o, a)
				;(b = k.fontName), (B = [k.fontClass])
			} else
				h
					? ((b = p1[m].fontName), (B = [m]))
					: ((b = Nr(m, t.fontWeight, t.fontShape)), (B = [m, t.fontWeight, t.fontShape]))
			if (Wr(l, b, n).metrics) return X0(l, b, n, t, o.concat(B))
			if (h1.hasOwnProperty(l) && b.slice(0, 10) === 'Typewriter') {
				for (var C = [], D = 0; D < l.length; D++) C.push(X0(l[D], b, n, t, o.concat(B)))
				return c1(C)
			}
		}
		if (a === 'mathord') return X0(l, 'Math-Italic', n, t, o.concat(['mathnormal']))
		if (a === 'textord') {
			var I = r0[n][l] && r0[n][l].font
			if (I === 'ams') {
				var N = Nr('amsrm', t.fontWeight, t.fontShape)
				return X0(l, N, n, t, o.concat('amsrm', t.fontWeight, t.fontShape))
			} else if (I === 'main' || !I) {
				var P = Nr('textrm', t.fontWeight, t.fontShape)
				return X0(l, P, n, t, o.concat(t.fontWeight, t.fontShape))
			} else {
				var U = Nr(I, t.fontWeight, t.fontShape)
				return X0(l, U, n, t, o.concat(U, t.fontWeight, t.fontShape))
			}
		} else throw new Error('unexpected type: ' + a + ' in makeOrd')
	},
	Js = (r, e) => {
		if (ye(r.classes) !== ye(e.classes) || r.skew !== e.skew || r.maxFontSize !== e.maxFontSize)
			return !1
	...
	k0 = function (e, t, a, n) {
		var l = new Vt(e, t, a, n)
		return Ca(l), l
	},
	m1 = (r, e, t, a) => new Vt(r, e, t, a),
	el = function (e, t, a) {
		var n = k0([e], [], t)
		return (
	...
	rl = function (e, t) {
		return e instanceof Ut ? k0([], [e], t) : e
	},
	al = function (e) {
		if (e.positionType === 'individualShift') {
			for (
				var t = e.children, a = [t[0]], n = -t[0].shift - t[0].elem.depth, l = n, o = 1;
				o < t.length;
				o++
			) {
				var h = -t[o].shift - l - t[o].elem.depth,
					m = h - (t[o - 1].elem.height + t[o - 1].elem.depth)
				;(l = l + h), a.push({ type: 'kern', size: m }), a.push(t[o])
			}
			return { children: a, depth: n }
		}
		var v
		if (e.positionType === 'top') {
			for (var y = e.positionData, b = 0; b < e.children.length; b++) {
				var B = e.children[b]
				y -= B.type === 'kern' ? B.size : B.elem.height + B.elem.depth
			}
			v = y
		} else if (e.positionType === 'bottom') v = -e.positionData
		else {
			var k = e.children[0]
			if (k.type !== 'elem') throw new Error('First child must have type "elem".')
			if (e.positionType === 'shift') v = -k.elem.depth - e.positionData
			else if (e.positionType === 'firstBaseline') v = -k.elem.depth
			else throw new Error('Invalid positionType ' + e.positionType + '.')
		}
		return { children: e.children, depth: v }
	},
	nl = function (e, t) {
		for (var { children: a, depth: n } = al(e), l = 0, o = 0; o < a.length; o++) {
			var h = a[o]
			if (h.type === 'elem') {
				var m = h.elem
		...
		var v = k0(['pstrut'], [])
		v.style.height = F(l)
		for (var y = [], b = n, B = n, k = n, C = 0; C < a.length; C++) {
			var D = a[C]
			if (D.type === 'kern') k += D.size
			else {
				var I = D.elem,
					N = D.wrapperClasses || [],
					P = D.wrapperStyle || {},
					U = k0(N, [v, I], void 0, P)
				;(U.style.top = F(-l - k - I.depth)),
					D.marginLeft && (U.style.marginLeft = D.marginLeft),
					D.marginRight && (U.style.marginRight = D.marginRight),
					y.push(U),
					(k += I.height + I.depth)
			}
			;(b = Math.min(b, k)), (B = Math.max(B, k))
		}
		var Z = k0(['vlist'], y)
		Z.style.height = F(B)
		var Y
		if (b < 0) {
			var K = k0([], []),
				j = k0(['vlist'], [K])
			j.style.height = F(-b)
			var t0 = k0(['vlist-s'], [new O0('​')])
			Y = [k0(['vlist-r'], [Z, t0]), k0(['vlist-r'], [j])]
		} else Y = [k0(['vlist-r'], [Z])]
		var J = k0(['vlist-t'], Y)
		return Y.length === 2 && J.classes.push('vlist-t2'), (J.height = B), (J.depth = -b), J
	},
	sl = (r, e) => {
		var t = k0(['mspace'], [], e),
			a = l0(r, e)
		return (t.style.marginRight = F(a)), t
	},
	Nr = function (e, t, a) {
		var n = ''
		switch (e) {
	...
	ll = function (e, t) {
		var [a, n, l] = d1[e],
			...
			m = m1(['overlay'], [h], t)
		return (m.height = l), (m.style.height = F(l)), (m.style.width = F(n)), m
	},
	x = {
		fontMap: p1,
		makeSymbol: X0,
	...
	ne = { number: 5, unit: 'mu' },
	il = {
		mord: { mop: s0, mbin: st, mrel: ne, minner: s0 },
		mop: { mord: s0, mop: s0, mrel: ne, minner: s0 },
		mbin: { mord: st, mop: st, mopen: st, minner: st },
		mrel: { mord: ne, mop: ne, mopen: ne, minner: ne },
		mopen: {},
		mclose: { mop: s0, mbin: st, mrel: ne, minner: s0 },
		mpunct: { mord: s0, mop: s0, mrel: ne, mopen: s0, mclose: s0, mpunct: s0, minner: s0 },
		minner: { mord: s0, mop: s0, mbin: st, mrel: ne, mopen: s0, mpunct: s0, minner: s0 }
	},
	ol = {
		mord: { mop: s0 },
		mop: { mord: s0, mop: s0 },
...
function E(r) {
	for (
		var { type: e, names: t, props: a, handler: n, htmlBuilder: l, mathmlBuilder: o } = r,
			h = {
				type: e,
				numArgs: a.numArgs,
				argTypes: a.argTypes,
...
var Vr = function (e) {
	...
	ue = x.makeSpan,
	ul = ['leftmost', 'mbin', 'mopen', 'mrel', 'mop', 'mpunct'],
	hl = ['rightmost', 'mrel', 'mclose', 'mpunct'],
	ml = { display: O.DISPLAY, text: O.TEXT, script: O.SCRIPT, scriptscript: O.SCRIPTSCRIPT },
	cl = {
		mord: 'mord',
		mop: 'mop',
		mbin: 'mbin',
	...
	h0 = function (e, t, a, n) {
		...
		if ((x.tryCombineChars(l), !a)) return l
		var v = t
		if (e.length === 1) {
			var y = e[0]
			y.type === 'sizing'
				? (v = t.havingSize(y.size))
				: y.type === 'styling' && (v = t.havingStyle(ml[y.style]))
		}
		var b = ue([n[0] || 'leftmost'], [], t),
			B = ue([n[1] || 'rightmost'], [], t),
			k = a === 'root'
		return (
			Cn(
				l,
				(C, D) => {
					var I = D.classes[0],
						N = C.classes[0]
					I === 'mbin' && $.contains(hl, N)
						? (D.classes[0] = 'mord')
						: N === 'mbin' && $.contains(ul, I) && (C.classes[0] = 'mord')
				},
				{ node: b },
				B,
				k
			...
			Cn(
				...
				(C, D) => {
					var I = xa(D),
						N = xa(C),
						P = I && N ? (C.hasClass('mtight') ? ol[I][N] : il[I][N]) : null
					if (P) return x.makeGlue(P, v)
				},
				{ node: b },
				B,
				k
	...
	Cn = function r(e, t, a, n, l) {
		...
		for (var o = 0; o < e.length; o++) {
			...
			if (v) {
				var y = t(h, a.node)
				y && (a.insertAfter ? a.insertAfter(y) : (e.unshift(y), o++))
			}
			v ? (a.node = h) : l && h.hasClass('newline') && (a.node = ue(['leftmost'])),
				(a.insertAfter = ((b) => (B) => {
					e.splice(b + 1, 0, B), o++
				})(o))
		}
	...
	v1 = function (e) {
		return e instanceof Ut || e instanceof za || (e instanceof Vt && e.hasClass('enclosing'))
			? e
			: null
	},
	pl = function r(e, t) {
	...
	xa = function (e, t) {
		return e ? (t && (e = pl(e, t)), cl[e.classes[0]] || null) : null
	},
	Gt = function (e, t) {
		var a = ['nulldelimiter'].concat(e.baseSizingClasses())
		return ue(t.concat(a))
	},
	Q = function (e, t, a) {
		if (!e) return ue()
		if ($r[e.type]) {
...
function Ir(r, e) {
	var t = ue(['base'], r, e),
		a = ue(['strut'])
	return (
		(a.style.height = F(t.height + t.depth)),
		t.depth && (a.style.verticalAlign = F(-t.depth)),
	...
	for (var l = [], o = [], h = 0; h < a.length; h++)
		if (
			...
			a[h].hasClass('newline') &&
				(o.pop(), o.length > 0 && (l.push(Ir(o, e)), (o = [])), l.push(a[h]))
	o.length > 0 && l.push(Ir(o, e))
	var v
	t ? ((v = Ir(h0(t, e, !0))), (v.classes = ['tag']), l.push(v)) : n && l.push(n)
	var y = ue(['katex-html'], l)
	if ((y.setAttribute('aria-hidden', 'true'), v)) {
		var b = v.children[0]
		;(b.style.height = F(y.height + y.depth)), y.depth && (b.style.verticalAlign = F(-y.depth))
	}
	return y
}
function g1(r) {
...
class R0 {
	...
	toNode() {
		...
		this.classes.length > 0 && (e.className = ye(this.classes))
	...
	toMarkup() {
		...
		for (var t in this.attributes)
			Object.prototype.hasOwnProperty.call(this.attributes, t) &&
				((e += ' ' + t + '="'), (e += $.escape(this.attributes[t])), (e += '"'))
		this.classes.length > 0 && (e += ' class ="' + $.escape(ye(this.classes)) + '"'), (e += '>')
		for (var a = 0; a < this.children.length; a++) e += this.children[a].toMarkup()
...
var T = { MathNode: R0, TextNode: Lt, SpaceNode: dl, newDocumentFragment: g1 },
	P0 = function (e, t, a) {
		return (
			r0[t][e] &&
				r0[t][e].replace &&
	...
	Fa = function (e, t) {
		...
		var l = e.text
		if ($.contains(['\\imath', '\\jmath'], l)) return null
		r0[n][l] && r0[n][l].replace && (l = r0[n][l].replace)
		var o = x.fontMap[a].fontName
		return Ta(l, o, n) ? x.fontMap[a].variant : null
	},
	S0 = function (e, t, a) {
		if (e.length === 1) {
			var n = e0(e[0], t)
		...
		for (var l = [], o, h = 0; h < e.length; h++) {
			var m = e0(e[h], t)
			if (m instanceof R0 && o instanceof R0) {
				if (
					m.type === 'mtext' &&
					o.type === 'mtext' &&
					m.getAttribute('mathvariant') === o.getAttribute('mathvariant')
				) {
					...
					if (
						...
						b instanceof Lt &&
							b.text.length > 0 &&
							((b.text = b.text.slice(0, 1) + '̸' + b.text.slice(1)), l.pop())
					}
				}
			}
			l.push(m), (o = m)
	...
	e0 = function (e, t) {
		if (!e) return new T.MathNode('mrow')
		if (Ur[e.type]) {
			var a = Ur[e.type](e, t)
			return a
		} else throw new z("Got group of unknown type: '" + e.type + "'")
	}
function Dn(r, e, t, a, n) {
	var l = S0(r, t),
		o
	l.length === 1 && l[0] instanceof R0 && $.contains(['mrow', 'mtable'], l[0].type)
		? (o = l[0])
		: (o = new T.MathNode('mrow', l))
	var h = new T.MathNode('annotation', [new T.TextNode(e)])
	h.setAttribute('encoding', 'application/x-tex')
	var m = new T.MathNode('semantics', [o, h]),
		v = new T.MathNode('math', [m])
	v.setAttribute('xmlns', 'http://www.w3.org/1998/Math/MathML'),
		a && v.setAttribute('display', 'block')
	var y = n ? 'katex' : 'katex-mathml'
	return x.makeSpan([y], [v])
}
var y1 = function (e) {
		return new se({
	...
	fl = function (e, t, a) {
		var n = y1(a),
			l
		if (a.output === 'mathml') return Dn(e, t, n, a.displayMode, !0)
		if (a.output === 'html') {
			var o = wa(e, n)
			l = x.makeSpan(['katex'], [o])
		} else {
			var h = Dn(e, t, n, a.displayMode, !1),
				m = wa(e, n)
	...
	yl = function (e) {
		var t = new T.MathNode('mo', [new T.TextNode(gl[e.replace(/^\\/, '')])])
	...
	wl = function (e, t) {
		function a() {
			var h = 4e5,
				m = e.label.slice(1)
			if ($.contains(['widehat', 'widecheck', 'widetilde', 'utilde'], m)) {
				var v = e,
					y = xl(v.base),
					b,
					B,
				...
				if (y > 5)
					m === 'widehat' || m === 'widecheck'
						? ((b = 420), (h = 2364), (k = 0.42), (B = m + '4'))
						: ((b = 312), (h = 2340), (k = 0.34), (B = 'tilde4'))
				else {
					var C = [1, 1, 2, 2, 3, 3][y]
					m === 'widehat' || m === 'widecheck'
						? ((h = [0, 1062, 2364, 2364, 2364][C]),
						  (b = [0, 239, 300, 360, 420][C]),
						  (k = [0, 0.24, 0.3, 0.3, 0.36, 0.42][C]),
						  (B = m + C))
						: ((h = [0, 600, 1033, 2339, 2340][C]),
						  (b = [0, 260, 286, 306, 312][C]),
						  (k = [0, 0.26, 0.286, 0.3, 0.306, 0.34][C]),
						  (B = 'tilde' + C))
				}
				var D = new be(B),
					I = new oe([D], {
				...
				return { span: x.makeSvgSpan([], [I], t), minWidth: 0, height: k }
			} else {
				var N = [],
					P = bl[m],
					[U, Z, Y] = P,
				...
				if (j === 1) {
					...
					(t0 = ['halfarrow-left', 'halfarrow-right']), (J = ['xMinYMin', 'xMaxYMin'])
				else if (j === 3)
					(t0 = ['brace-left', 'brace-center', 'brace-right']),
				...
				for (var m0 = 0; m0 < j; m0++) {
					var a0 = new be(U[m0]),
						y0 = new oe([a0], {
							width: '400em',
							height: F(K),
							viewBox: '0 0 ' + h + ' ' + Y,
							preserveAspectRatio: J[m0] + ' slice'
						}),
						p0 = x.makeSvgSpan([t0[m0]], [y0], t)
					if (j === 1) return { span: p0, minWidth: Z, height: K }
					;(p0.style.height = F(K)), N.push(p0)
				}
				return { span: x.makeSpan(['stretchy'], N, t), minWidth: Z, height: K }
			}
		}
		var { span: n, minWidth: l, height: o } = a()
		return (n.height = o), (n.style.height = F(o)), l > 0 && (n.style.minWidth = F(l)), n
	},
	Bl = function (e, t, a, n, l) {
		var o,
		...
		if (/fbox|color|angl/.test(t)) {
			...
			;/^[bx]cancel$/.test(t) &&
				v.push(
					new ya({ x1: '0', y1: '0', x2: '100%', y2: '100%', 'stroke-width': '0.046em' })
				),
				/^x?cancel$/.test(t) &&
					v.push(
						new ya({
			...
			var y = new oe(v, { width: '100%', height: F(h) })
			o = x.makeSvgSpan([], [y], l)
		}
		return (o.height = h), (o.style.height = F(h)), o
	},
	he = { encloseSpan: Bl, mathMLnode: yl, svgSpan: wl }
function X(r, e) {
	if (!r || r.type !== e)
		throw new Error(
...
function Xr(r) {
	return r && (r.type === 'atom' || Xs.hasOwnProperty(r.type)) ? r : null
}
var Na = (r, e) => {
		var t, a, n
		r && r.type === 'supsub'
			? ((a = X(r.base, 'accent')),
			  ...
			  (n = _s(Q(r, e))),
			  (r.base = a))
			: ((a = X(r, 'accent')), (t = a.base))
		var l = Q(t, e.havingCrampedStyle()),
			o = a.isShifty && $.isCharacterBox(t),
			h = 0
		if (o) {
			var m = $.getBaseElem(t),
				v = Q(m, e.havingCrampedStyle())
			h = kn(v).skew
		}
		var y = a.label === '\\c',
			b = y ? l.height + l.depth : Math.min(l.height, e.fontMetrics().xHeight),
			B
		if (a.isStretchy)
			(B = he.svgSpan(a, e)),
				(B = x.makeVList(
			...
			var k, C
			a.label === '\\vec'
				? ((k = x.staticSvg('vec', e)), (C = x.svgData.vec[1]))
				: ((k = x.makeOrd({ mode: a.mode, text: a.label }, e, 'textord')),
				  (k = kn(k)),
				  (k.italic = 0),
				  (C = k.width),
				  y && (b += k.depth)),
				(B = x.makeSpan(['accent-body'], [k]))
			var D = a.label === '\\textcircled'
			D && (B.classes.push('accent-full'), (b = l.height))
			var I = h
			D || (I -= C / 2),
				(B.style.left = F(I)),
		...
		var N = x.makeSpan(['mord', 'accent'], [B], e)
		return n
			? ((n.children[0] = N),
	...
	x1 = (r, e) => {
		var t = r.isStretchy ? he.mathMLnode(r.label) : new T.MathNode('mo', [P0(r.label, r.mode)]),
			a = new T.MathNode('mover', [e0(r.base, e), t])
...
E({
	...
	mathmlBuilder: (r, e) => {
		var t = he.mathMLnode(r.label),
			a = new T.MathNode('munder', [e0(r.base, e), t])
...
E({
	...
	htmlBuilder(r, e) {
		var t = e.style,
			...
			n = x.wrapFragment(Q(r.body, a, e), e),
			l = r.label.slice(0, 2) === '\\x' ? 'x' : 'cd'
		n.classes.push(l + '-arrow-pad')
		var o
		r.below &&
			((a = e.havingStyle(t.sub())),
			(o = x.wrapFragment(Q(r.below, a, e), e)),
			o.classes.push(l + '-arrow-pad'))
		var h = he.svgSpan(r, e),
		...
		return (
			y.children[0].children[0].children[1].classes.push('svg-align'),
			x.makeSpan(['mrel', 'x-arrow'], [y], e)
		)
	},
	mathmlBuilder(r, e) {
		var t = he.mathMLnode(r.label)
		...
		var a
		if (r.body) {
			var n = qr(e0(r.body, e))
			if (r.below) {
				var l = qr(e0(r.below, e))
				a = new T.MathNode('munderover', [t, l, n])
			} else a = new T.MathNode('mover', [t, n])
		} else if (r.below) {
			var o = qr(e0(r.below, e))
			a = new T.MathNode('munder', [t, o])
		} else (a = qr()), (a = new T.MathNode('mover', [t, a]))
		return a
	}
})
var Sl = x.makeSpan
...
function B1(r, e) {
	...
	return (
		r.mclass === 'minner'
			? (t = new T.MathNode('mpadded', a))
			: r.mclass === 'mord'
			? r.isCharacterBox
				? ((t = a[0]), (t.type = 'mi'))
				: (t = new T.MathNode('mi', a))
			: (r.isCharacterBox ? ((t = a[0]), (t.type = 'mo')) : (t = new T.MathNode('mo', a)),
			  r.mclass === 'mbin'
...
E({
	...
	handler(r, e) {
		var { parser: t } = r
		return { type: 'pmb', mode: t.mode, mclass: Yr(e[0]), body: o0(e[0]) }
	},
	htmlBuilder(r, e) {
		var t = h0(r.body, e, !0),
			a = x.makeSpan([r.mclass], t, e)
		return (a.style.textShadow = '0.02em 0.01em 0.04px'), a
	},
	mathmlBuilder(r, e) {
		var t = S0(r.body, e),
			a = new T.MathNode('mstyle', t)
...
var Al = {
	...
	Fn = () => ({ type: 'styling', body: [], mode: 'math', style: 'display' }),
	En = (r) => r.type === 'textord' && r.text === '@',
	Ml = (r, e) => (r.type === 'mathord' || r.type === 'atom') && r.text === e
function Tl(r, e, t) {
	var a = Al[r]
	switch (a) {
		case '\\\\cdrightarrow':
		...
		case '\\downarrow': {
			var n = t.callFunction('\\\\cdleft', [e[0]], []),
				...
				o = t.callFunction('\\Big', [l], []),
				h = t.callFunction('\\\\cdright', [e[1]], []),
				m = { type: 'ordgroup', mode: 'math', body: [n, o, h] }
...
function zl(r) {
	...
	for (var a = [], n = [a], l = 0; l < e.length; l++) {
		for (var o = e[l], h = Fn(), m = 0; m < o.length; m++)
			if (!En(o[m])) h.body.push(o[m])
			else {
				a.push(h), (m += 1)
				var v = Ea(o[m]).text,
					y = new Array(2)
				if (
					((y[0] = { type: 'ordgroup', mode: 'math', body: [] }),
					(y[1] = { type: 'ordgroup', mode: 'math', body: [] }),
					!('=|.'.indexOf(v) > -1))
				)
					if ('<>AV'.indexOf(v) > -1)
						for (var b = 0; b < 2; b++) {
							for (var B = !0, k = m + 1; k < o.length; k++) {
								if (Ml(o[k], v)) {
									;(B = !1), (m = k)
									break
								}
								if (En(o[k]))
									throw new z(
										'Missing a ' + v + ' character to complete a CD arrow.',
										o[k]
									)
								y[b].body.push(o[k])
							}
					...
					else throw new z('Expected one of "<>AV=|." after @', o[m])
				var C = Tl(v, y, r),
					D = { type: 'styling', body: [C], mode: 'math', style: 'display' }
				a.push(D), (h = Fn())
			}
		l % 2 === 0 ? a.push(h) : a.shift(), (a = []), n.push(a)
	}
	r.gullet.endGroup(), r.gullet.endGroup()
	var I = new Array(n[0].length).fill({ type: 'align', align: 'c', pregap: 0.25, postgap: 0.25 })
	return {
		type: 'array',
		mode: 'math',
		body: n,
...
E({
	...
	htmlBuilder(r, e) {
		var t = e.havingStyle(e.style.sup()),
			a = x.wrapFragment(Q(r.label, t, e), e)
		return (
	...
	mathmlBuilder(r, e) {
		var t = new T.MathNode('mrow', [e0(r.label, e)])
		return (
			(t = new T.MathNode('mpadded', [t])),
...
E({
	...
	htmlBuilder(r, e) {
		var t = x.wrapFragment(Q(r.fragment, e), e)
		return t.classes.push('cd-vert-arrow'), t
	},
	mathmlBuilder(r, e) {
		return new T.MathNode('mrow', [e0(r.fragment, e)])
	}
})
E({
	type: 'textord',
	...
	handler(r, e) {
		for (
			var { parser: t } = r, a = X(e[0], 'ordgroup'), n = a.body, l = '', o = 0;
			o < n.length;
			o++
		) {
			var h = X(n[o], 'textord')
		...
		var m = parseInt(l),
			v
		if (isNaN(m)) throw new z('\\@char has non-numeric argument ' + l)
		if (m < 0 || m >= 1114111) throw new z('\\@char with invalid code point ' + l)
		return (
			m <= 65535
				? (v = String.fromCharCode(m))
				: ((m -= 65536), (v = String.fromCharCode((m >> 10) + 55296, (m & 1023) + 56320))),
			{ type: 'textord', mode: t.mode, text: v }
		)
	}
})
var k1 = (r, e) => {
		var t = h0(r.body, e.withColor(r.color), !1)
		return x.makeFragment(t)
	},
	S1 = (r, e) => {
		var t = S0(r.body, e.withColor(r.color)),
			a = new T.MathNode('mstyle', t)
...
E({
	...
	handler(r, e) {
		var { parser: t } = r,
			...
			n = e[1]
		return { type: 'color', mode: t.mode, color: a, body: o0(n) }
	},
	htmlBuilder: k1,
	mathmlBuilder: S1
})
...
E({
	...
	handler(r, e, t) {
		...
		return { type: 'cr', mode: a.mode, newLine: l, size: n && X(n, 'size').value }
	},
	htmlBuilder(r, e) {
		var t = x.makeSpan(['mspace'], [], e)
		return (
			r.newLine &&
				(t.classes.push('newline'), r.size && (t.style.marginTop = F(l0(r.size, e)))),
			t
		)
	},
	mathmlBuilder(r, e) {
		...
		return (
			r.newLine &&
				...
				r.size && t.setAttribute('height', F(l0(r.size, e)))),
			t
		)
	}
})
var Ba = {
	...
	Cl = (r) => {
		...
		return (
			e.text === '=' &&
				((e = r.gullet.popToken()), e.text === ' ' && (e = r.gullet.popToken())),
			e
		)
	},
	M1 = (r, e, t, a) => {
...
E({
	...
	handler(r) {
		...
		if (Ba[a.text])
			return (
				(t === '\\global' || t === '\\\\globallong') && (a.text = Ba[a.text]),
...
E({
	...
	handler(r) {
		...
		return (
			...
			e.gullet.macros.set(n, { tokens: m, numArgs: l, delimiters: h }, t === Ba[t]),
...
E({
	...
	handler(r) {
		var { parser: e, funcName: t } = r,
			a = A1(e.gullet.popToken())
		e.gullet.consumeSpaces()
		var n = Cl(e)
		return M1(e, a, n, t === '\\\\globallet'), { type: 'internal', mode: e.mode }
	}
})
E({
	type: 'internal',
...
var Rt = function (e, t, a) {
		var n = r0.math[e] && r0.math[e].replace,
			l = Ta(n || e, t, a)
	...
	Ia = function (e, t, a, n) {
		var l = a.havingBaseStyle(t),
			o = x.makeSpan(n.concat(l.sizingClasses(a)), [e], a),
	...
	T1 = function (e, t, a) {
		...
		e.classes.push('delimcenter'), (e.style.top = F(l)), (e.height -= l), (e.depth += l)
	},
	Dl = function (e, t, a, n, l, o) {
		var h = x.makeSymbol(e, 'Main-Regular', l, n),
			m = Ia(h, t, n, o)
		return a && T1(m, n, t), m
	},
	Fl = function (e, t, a, n) {
	...
	z1 = function (e, t, a, n, l, o) {
		var h = Fl(e, t, l, n),
			m = Ia(x.makeSpan(['delimsizing', 'size' + t], [h], n), O.TEXT, n, o)
		return a && T1(m, n, O.TEXT), m
	},
	la = function (e, t, a) {
		var n
	...
	ia = function (e, t, a) {
		var n = K0['Size4-Regular'][e.charCodeAt(0)]
			...
			l = new be('inner', Rs(e, Math.round(1e3 * t))),
			o = new oe([l], {
				width: F(n),
				height: F(t),
				style: 'width:' + F(n),
	...
	ka = 0.008,
	Hr = { type: 'kern', size: -1 * ka },
	El = ['|', '\\lvert', '\\rvert', '\\vert'],
	Nl = ['\\|', '\\lVert', '\\rVert', '\\Vert'],
	C1 = function (e, t, a, n, l, o) {
		var h,
			m,
			v,
			y,
		...
		e === '\\uparrow'
			...
			? (h = v = '‖')
			: e === '\\updownarrow'
			? ((h = '\\uparrow'), (v = '⏐'), (y = '\\downarrow'))
			: e === '\\Updownarrow'
			? ((h = '\\Uparrow'), (v = '‖'), (y = '\\Downarrow'))
			: $.contains(El, e)
			? ((v = '∣'), (b = 'vert'), (B = 333))
			: $.contains(Nl, e)
			? ((v = '∥'), (b = 'doublevert'), (B = 556))
			: e === '[' || e === '\\lbrack'
			? ((h = '⎡'), (v = '⎢'), (y = '⎣'), (k = 'Size4-Regular'), (b = 'lbrack'), (B = 667))
			: e === ']' || e === '\\rbrack'
			? ((h = '⎤'), (v = '⎥'), (y = '⎦'), (k = 'Size4-Regular'), (b = 'rbrack'), (B = 667))
			: e === '\\lfloor' || e === '⌊'
			? ((v = h = '⎢'), (y = '⎣'), (k = 'Size4-Regular'), (b = 'lfloor'), (B = 667))
			: e === '\\lceil' || e === '⌈'
			? ((h = '⎡'), (v = y = '⎢'), (k = 'Size4-Regular'), (b = 'lceil'), (B = 667))
			: e === '\\rfloor' || e === '⌋'
			? ((v = h = '⎥'), (y = '⎦'), (k = 'Size4-Regular'), (b = 'rfloor'), (B = 667))
			: e === '\\rceil' || e === '⌉'
			? ((h = '⎤'), (v = y = '⎥'), (k = 'Size4-Regular'), (b = 'rceil'), (B = 667))
			: e === '(' || e === '\\lparen'
			? ((h = '⎛'), (v = '⎜'), (y = '⎝'), (k = 'Size4-Regular'), (b = 'lparen'), (B = 875))
			: e === ')' || e === '\\rparen'
			? ((h = '⎞'), (v = '⎟'), (y = '⎠'), (k = 'Size4-Regular'), (b = 'rparen'), (B = 875))
			: e === '\\{' || e === '\\lbrace'
			? ((h = '⎧'), (m = '⎨'), (y = '⎩'), (v = '⎪'), (k = 'Size4-Regular'))
			: e === '\\}' || e === '\\rbrace'
			? ((h = '⎫'), (m = '⎬'), (y = '⎭'), (v = '⎪'), (k = 'Size4-Regular'))
			: e === '\\lgroup' || e === '⟮'
			? ((h = '⎧'), (y = '⎩'), (v = '⎪'), (k = 'Size4-Regular'))
			: e === '\\rgroup' || e === '⟯'
			? ((h = '⎫'), (y = '⎭'), (v = '⎪'), (k = 'Size4-Regular'))
			: e === '\\lmoustache' || e === '⎰'
			? ((h = '⎧'), (y = '⎭'), (v = '⎪'), (k = 'Size4-Regular'))
		...
		if (m !== null) {
			var K = Rt(m, k, l)
			;(Z = K.height + K.depth), (Y = 2)
		}
		var j = D + U + Z,
			t0 = Math.max(0, Math.ceil((t - j) / (Y * N))),
			J = j + t0 * Y * N,
		...
		if (b.length > 0) {
			var y0 = J - D - U,
				p0 = Math.round(J * 1e3),
				f0 = Ls(b, Math.round(y0 * 1e3)),
				v0 = new be(b, f0),
				G0 = (B / 1e3).toFixed(3) + 'em',
				B0 = (p0 / 1e3).toFixed(3) + 'em',
				ce = new oe([v0], { width: G0, height: B0, viewBox: '0 0 ' + B + ' ' + p0 }),
				g0 = x.makeSvgSpan([], [ce], n)
			;(g0.height = p0 / 1e3),
				(g0.style.width = G0),
				(g0.style.height = B0),
				a0.push({ type: 'elem', elem: g0 })
		} else {
			if ((a0.push(la(y, k, l)), a0.push(Hr), m === null)) {
				var $0 = J - D - U + 2 * ka
				a0.push(ia(v, $0, n))
			} else {
				var d0 = (J - D - U - Z) / 2 + 2 * ka
				a0.push(ia(v, d0, n)),
					a0.push(Hr),
					a0.push(la(m, k, l)),
					a0.push(Hr),
			...
			a0.push(Hr), a0.push(la(h, k, l))
		}
		var A0 = n.havingBaseStyle(O.TEXT),
			it = x.makeVList({ positionType: 'bottom', positionData: m0, children: a0 }, A0)
		return Ia(x.makeSpan(['delimsizing', 'mult'], [it], A0), O.TEXT, n, o)
	},
	oa = 80,
	ua = 0.08,
	ha = function (e, t, a, n, l) {
		var o = Hs(e, n, a),
			h = new be(e, o),
			m = new oe([h], {
				width: '400em',
	...
	Il = function (e, t) {
		var a = t.havingBaseSizing(),
			n = N1('\\surd', e * a.sizeMultiplier, E1, a),
			l = a.sizeMultiplier,
		...
		return (
			n.type === 'small'
				...
				? ((y = (1e3 + oa) * Ot[n.size]),
				  (v = (Ot[n.size] + o) / l),
				  (m = (Ot[n.size] + o + ua) / l),
				  (h = ha('sqrtSize' + n.size, m, y, o, t)),
				  (h.style.minWidth = '1.02em'),
				  (b = 1 / l))
				: ((m = e + o + ua),
				  (v = e + o),
				  (y = Math.floor(1e3 * e + o) + oa),
				  (h = ha('sqrtTall', m, y, o, t)),
				  (h.style.minWidth = '0.742em'),
				  (b = 1.056)),
			(h.height = v),
			(h.style.height = F(m)),
			{ span: h, advanceWidth: b, ruleWidth: (t.fontMetrics().sqrtRuleThickness + o) * l }
		)
	},
	D1 = [
		'(',
	...
	F1 = ['<', '>', '\\langle', '\\rangle', '/', '\\backslash', '\\lt', '\\gt'],
	Ot = [0, 1.2, 1.8, 2.4, 3],
	Hl = function (e, t, a, n, l) {
		if (
			(e === '<' || e === '\\lt' || e === '⟨'
				? (e = '\\langle')
				: (e === '>' || e === '\\gt' || e === '⟩') && (e = '\\rangle'),
			$.contains(D1, e) || $.contains(F1, e))
		)
			return z1(e, t, !1, a, n, l)
		if ($.contains(ql, e)) return C1(e, Ot[t], !1, a, n, l)
		throw new z("Illegal delimiter: '" + e + "'")
	},
	Rl = [
		{ type: 'small', style: O.SCRIPTSCRIPT },
		{ type: 'small', style: O.SCRIPT },
		{ type: 'small', style: O.TEXT },
		{ type: 'large', size: 1 },
		{ type: 'large', size: 2 },
		{ type: 'large', size: 3 },
		{ type: 'large', size: 4 }
	...
	N1 = function (e, t, a, n) {
		for (
			var l = Math.min(2, 3 - n.style.size), o = l;
			o < a.length && a[o].type !== 'stack';
			o++
		) {
			var h = Rt(e, Ol(a[o]), 'math'),
				m = h.height + h.depth
			if (a[o].type === 'small') {
	...
	I1 = function (e, t, a, n, l, o) {
		e === '<' || e === '\\lt' || e === '⟨'
			? (e = '\\langle')
			: (e === '>' || e === '\\gt' || e === '⟩') && (e = '\\rangle')
		var h
		$.contains(F1, e) ? (h = Rl) : $.contains(D1, e) ? (h = E1) : (h = Ll)
		var m = N1(e, t, h, n)
		return m.type === 'small'
			? Dl(e, m.style, a, n, l, o)
			: m.type === 'large'
			? z1(e, m.size, a, n, l, o)
			: C1(e, t, a, n, l, o)
	},
	Pl = function (e, t, a, n, l, o) {
		var h = n.fontMetrics().axisHeight * n.sizeMultiplier,
			m = 901,
			v = 5 / n.fontMetrics().ptPerEm,
			y = Math.max(t - h, a + h),
			b = Math.max((y / 500) * m, 2 * y - v)
		return I1(e, b, !0, n, l, o)
	},
	ie = {
		sqrtImage: Il,
		sizedDelim: Hl,
...
function jr(r, e) {
	var t = Xr(r)
	if (t && $.contains(Gl, t.text)) return t
	throw t
		? new z("Invalid delimiter '" + t.text + "' after '" + e.funcName + "'", r)
		: new z("Invalid delimiter type '" + r.type + "'", r)
}
E({
	type: 'delimsizing',
	names: [
	...
	handler: (r, e) => {
		...
		return {
			type: 'delimsizing',
			mode: r.parser.mode,
			size: Nn[r.funcName].size,
			mclass: Nn[r.funcName].mclass,
			delim: t.text
		}
	},
	htmlBuilder: (r, e) =>
		r.delim === '.'
			? x.makeSpan([r.mclass])
			: ie.sizedDelim(r.delim, r.size, e, r.mode, [r.mclass]),
	mathmlBuilder: (r) => {
		var e = []
		...
		var a = F(ie.sizeToMaxHeight[r.size])
...
E({
	...
	handler: (r, e) => {
		...
		return { type: 'leftright-right', mode: r.parser.mode, delim: jr(e[0], r).text, color: t }
	}
})
E({
	type: 'leftright',
	...
	handler: (r, e) => {
		...
		var l = X(a.parseFunction(), 'leftright-right')
		return {
			type: 'leftright',
			mode: a.mode,
			body: n,
	...
	htmlBuilder: (r, e) => {
		In(r)
		for (
			var t = h0(r.body, e, !0, ['mopen', 'mclose']), a = 0, n = 0, l = !1, o = 0;
			o < t.length;
			o++
		)
			t[o].isMiddle
		...
		if (
			(r.left === '.'
				? (h = Gt(e, ['mopen']))
				: (h = ie.leftRightDelim(r.left, a, n, e, r.mode, ['mopen'])),
			t.unshift(h),
			l)
		)
			for (var m = 1; m < t.length; m++) {
				var v = t[m],
					y = v.isMiddle
				y && (t[m] = ie.leftRightDelim(y.delim, a, n, y.options, r.mode, []))
			}
		var b
		if (r.right === '.') b = Gt(e, ['mclose'])
		else {
			var B = r.rightColor ? e.withColor(r.rightColor) : e
			b = ie.leftRightDelim(r.right, a, n, B, r.mode, ['mclose'])
		}
	...
	mathmlBuilder: (r, e) => {
		...
		var t = S0(r.body, e)
		if (r.left !== '.') {
			var a = new T.MathNode('mo', [P0(r.left, r.mode)])
			a.setAttribute('fence', 'true'), t.unshift(a)
		}
		if (r.right !== '.') {
			var n = new T.MathNode('mo', [P0(r.right, r.mode)])
...
E({
	...
	htmlBuilder: (r, e) => {
		...
		if (r.delim === '.') t = Gt(e, [])
			...
			t = ie.sizedDelim(r.delim, 1, e, r.mode, [])
	...
	mathmlBuilder: (r, e) => {
		var t = r.delim === '\\vert' || r.delim === '|' ? P0('|', 'text') : P0(r.delim, r.mode),
			a = new T.MathNode('mo', [t])
		return (
...
var qa = (r, e) => {
		var t = x.wrapFragment(Q(r.body, e), e),
			a = r.label.slice(1),
			n = e.sizeMultiplier,
			l,
			o = 0,
			h = $.isCharacterBox(r.body)
		if (a === 'sout')
			(l = x.makeSpan(['stretchy', 'sout'])),
				(l.height = e.fontMetrics().defaultRuleThickness / n),
				(o = -0.5 * e.fontMetrics().xHeight)
		else if (a === 'phase') {
			var m = l0({ number: 0.6, unit: 'pt' }, e),
				v = l0({ number: 0.35, unit: 'ex' }, e),
				y = e.havingBaseSizing()
			n = n / y.sizeMultiplier
			var b = t.height + t.depth + m + v
			t.style.paddingLeft = F(b / 2 + m)
			var B = Math.floor(1e3 * b * n),
				k = Is(B),
				C = new oe([new be('phase', k)], {
					width: '400em',
					height: F(B / 1e3),
					viewBox: '0 0 400000 ' + B,
					preserveAspectRatio: 'xMinYMin slice'
				})
			;(l = x.makeSvgSpan(['hide-tail'], [C], e)),
				(l.style.height = F(b)),
				(o = t.depth + m + v)
		} else {
			;/cancel/.test(a)
			...
			;/box/.test(a)
				? ((N = Math.max(e.fontMetrics().fboxrule, e.minRuleThickness)),
				  (D = e.fontMetrics().fboxsep + (a === 'colorbox' ? 0 : N)),
				  (I = D))
				: a === 'angl'
				? ((N = Math.max(e.fontMetrics().defaultRuleThickness, e.minRuleThickness)),
				  (D = 4 * N),
				  (I = Math.max(0, 0.25 - t.depth)))
				: ((D = h ? 0.2 : 0), (I = D)),
				(l = he.encloseSpan(t, a, D, I, e)),
				/fbox|boxed|fcolorbox/.test(a)
					? ((l.style.borderStyle = 'solid'), (l.style.borderWidth = F(N)))
					: a === 'angl' &&
					  N !== 0.049 &&
					  ((l.style.borderTopWidth = F(N)), (l.style.borderRightWidth = F(N))),
				(o = t.depth + I),
				r.backgroundColor &&
					((l.style.backgroundColor = r.backgroundColor),
					r.borderColor && (l.style.borderColor = r.borderColor))
		}
		var P
			...
			P = x.makeVList(
				{
					...
					children: [
						{ type: 'elem', elem: t, shift: 0 },
						{ type: 'elem', elem: l, shift: o, wrapperClasses: U }
					]
				},
				e
			)
		...
		return (
			/cancel/.test(a) && ((P.height = t.height), (P.depth = t.depth)),
			/cancel/.test(a) && !h
				? x.makeSpan(['mord', 'cancel-lap'], [P], e)
				: x.makeSpan(['mord'], [P], e)
		)
	},
	Ha = (r, e) => {
		var t = 0,
			a = new T.MathNode(r.label.indexOf('colorbox') > -1 ? 'mpadded' : 'menclose', [
				e0(r.body, e)
			])
		switch (r.label) {
			case '\\cancel':
...
E({
	...
	handler(r, e, t) {
		var { parser: a, funcName: n } = r,
			l = X(e[0], 'color-token').color,
			o = e[1]
		return { type: 'enclose', mode: a.mode, label: n, backgroundColor: l, body: o }
	},
	htmlBuilder: qa,
	mathmlBuilder: Ha
})
...
function we(r, e, t) {
	...
	if ((r.gullet.beginGroup(), v || r.gullet.macros.set('\\cr', '\\\\\\relax'), !o)) {
		...
		if (k == null) o = 1
		else if (((o = parseFloat(k)), !o || o < 0)) throw new z('Invalid \\arraystretch: ' + k)
	}
	r.gullet.beginGroup()
	var C = [],
		D = [C],
	...
	function Z() {
		P &&
			(r.gullet.macros.get('\\df@tag')
				? (P.push(r.subparse([new J0('\\df@tag')])),
				  r.gullet.macros.set('\\df@tag', void 0, !0))
				: P.push(!!m && r.gullet.macros.get('\\@eqnsw') === '1'))
	}
	for (U(), N.push(qn(r)); ; ) {
		var Y = r.parseExpression(!1, v ? '\\end' : '\\\\')
		r.gullet.endGroup(),
			r.gullet.beginGroup(),
			(Y = { type: 'ordgroup', mode: r.mode, body: Y }),
			t && (Y = { type: 'styling', mode: r.mode, style: t, body: [Y] }),
			C.push(Y)
		var K = r.fetch().text
		if (K === '&') {
			if (b && C.length === b) {
			...
			Z(),
				C.length === 1 &&
					Y.type === 'styling' &&
					Y.body[0].body.length === 0 &&
					(D.length > 1 || !y) &&
					D.pop(),
				N.length < D.length + 1 && N.push([])
			break
		} else if (K === '\\\\') {
			r.consume()
			var j = void 0
			r.gullet.future().text !== ' ' && (j = r.parseSizeGroup(!0)),
				I.push(j ? j.value : null),
				Z(),
				N.push(qn(r)),
				(C = []),
				D.push(C),
...
var ee = function (e, t) {
		var a,
			...
			m = new Array(l),
			v = [],
			y = Math.max(t.fontMetrics().arrayRuleWidth, t.minRuleThickness),
			b = 1 / t.fontMetrics().ptPerEm,
			B = 5 * b
		if (e.colSeparationType && e.colSeparationType === 'small') {
			var k = t.havingStyle(O.SCRIPT).sizeMultiplier
			B = 0.2778 * (k / t.sizeMultiplier)
		}
		var C = e.colSeparationType === 'CD' ? l0({ number: 3, unit: 'ex' }, t) : 12 * b,
			D = 3 * b,
			I = e.arraystretch * C,
			N = 0.7 * I,
			P = 0.3 * I,
			U = 0
		function Z(C0) {
			for (var ke = 0; ke < C0.length; ++ke)
				ke > 0 && (U += 0.25), v.push({ pos: U, isDashed: C0[ke] })
		}
		for (Z(o[0]), a = 0; a < e.body.length; ++a) {
			var Y = e.body[a],
				K = N,
				j = P
			h < Y.length && (h = Y.length)
			var t0 = new Array(Y.length)
			for (n = 0; n < Y.length; ++n) {
				var J = Q(Y[n], t)
				j < J.depth && (j = J.depth), K < J.height && (K = J.height), (t0[n] = J)
			}
			var c0 = e.rowGaps[a],
				m0 = 0
			c0 && ((m0 = l0(c0, t)), m0 > 0 && ((m0 += P), j < m0 && (j = m0), (m0 = 0))),
				e.addJot && (j += D),
				(t0.height = K),
				(t0.depth = j),
				(U += K),
		...
		var a0 = U / 2 + t.fontMetrics().axisHeight,
			y0 = e.cols || [],
			p0 = [],
			f0,
			v0,
		...
		if (e.tags && e.tags.some((C0) => C0))
			for (a = 0; a < l; ++a) {
				var B0 = m[a],
					...
					$0 = void 0
				g0 === !0
					? ($0 = x.makeSpan(['eqn-num'], [], t))
					: g0 === !1
					? ($0 = x.makeSpan([], [], t))
					: ($0 = x.makeSpan([], h0(g0, t, !0), t)),
					($0.depth = B0.depth),
					($0.height = B0.height),
					G0.push({ type: 'elem', elem: $0, shift: ce })
			}
		for (n = 0, v0 = 0; n < h || v0 < y0.length; ++n, ++v0) {
			for (var d0 = y0[v0] || {}, A0 = !0; d0.type === 'separator'; ) {
				if (
					(A0 ||
						((f0 = x.makeSpan(['arraycolsep'], [])),
						(f0.style.width = F(t.fontMetrics().doubleRuleSep)),
						p0.push(f0)),
					d0.separator === '|' || d0.separator === ':')
				) {
					var it = d0.separator === '|' ? 'solid' : 'dashed',
						U0 = x.makeSpan(['vertical-separator'], [], t)
					;(U0.style.height = F(U)),
						(U0.style.borderRightWidth = F(y)),
						(U0.style.borderRightStyle = it),
						(U0.style.margin = '0 ' + F(-y / 2))
					var Y0 = U - a0
					Y0 && (U0.style.verticalAlign = F(-Y0)), p0.push(U0)
				} else throw new z('Invalid separator type: ' + d0.separator)
				v0++, (d0 = y0[v0] || {}), (A0 = !1)
			}
			if (!(n >= h)) {
				var re = void 0
				;(n > 0 || e.hskipBeforeAndAfter) &&
					((re = $.deflt(d0.pregap, B)),
					re !== 0 &&
						((f0 = x.makeSpan(['arraycolsep'], [])),
						(f0.style.width = F(re)),
						p0.push(f0)))
				...
				for (a = 0; a < l; ++a) {
					...
					if (Be) {
						...
						;(Be.depth = z0.depth),
							(Be.height = z0.height),
							V0.push({ type: 'elem', elem: Be, shift: ot })
					}
				}
				;(V0 = x.makeVList({ positionType: 'individualShift', children: V0 }, t)),
					(V0 = x.makeSpan(['col-align-' + (d0.align || 'c')], [V0])),
					p0.push(V0),
					(n < h - 1 || e.hskipBeforeAndAfter) &&
						((re = $.deflt(d0.postgap, B)),
						re !== 0 &&
							((f0 = x.makeSpan(['arraycolsep'], [])),
							(f0.style.width = F(re)),
							p0.push(f0)))
		...
		if (((m = x.makeSpan(['mtable'], p0)), v.length > 0)) {
			for (
				var ae = x.makeLineSpan('hline', t, y),
					Wt = x.makeLineSpan('hdashline', t, y),
					pe = [{ type: 'elem', elem: m, shift: 0 }];
				v.length > 0;
				...
				var j0 = v.pop(),
					ft = j0.pos - a0
				j0.isDashed
					? pe.push({ type: 'elem', elem: Wt, shift: ft })
					: pe.push({ type: 'elem', elem: ae, shift: ft })
			}
			m = x.makeVList({ positionType: 'individualShift', children: pe }, t)
		}
		if (G0.length === 0) return x.makeSpan(['mord'], [m], t)
		var de = x.makeVList({ positionType: 'individualShift', children: G0 }, t)
		return (de = x.makeSpan(['tag'], [de], t)), x.makeFragment([m, de])
	},
	$l = { c: 'center ', l: 'left ', r: 'right ' },
	te = function (e, t) {
		for (
			var a = [],
				n = new T.MathNode('mtd', [], ['mtr-glue']),
				l = new T.MathNode('mtd', [], ['mml-eqn-num']),
				o = 0;
			o < e.body.length;
			o++
		) {
			for (var h = e.body[o], m = [], v = 0; v < h.length; v++)
				m.push(new T.MathNode('mtd', [e0(h[v], t)]))
			e.tags && e.tags[o] && (m.unshift(n), m.push(n), e.leqno ? m.unshift(l) : m.push(l)),
				a.push(new T.MathNode('mtr', m))
		}
		var y = new T.MathNode('mtable', a),
			b = e.arraystretch === 0.5 ? 0.1 : 0.16 + e.arraystretch - 1 + (e.addJot ? 0.09 : 0)
		y.setAttribute('rowspacing', F(b))
		var B = '',
			k = ''
		if (e.cols && e.cols.length > 0) {
			var C = e.cols,
				...
				N = 0,
				P = C.length
			C[0].type === 'separator' && ((B += 'top '), (N = 1)),
				C[C.length - 1].type === 'separator' && ((B += 'bottom '), (P -= 1))
			for (var U = N; U < P; U++)
				C[U].type === 'align'
					? ((k += $l[C[U].align]), I && (D += 'none '), (I = !0))
					: C[U].type === 'separator' &&
					  I &&
					  ((D += C[U].separator === '|' ? 'solid ' : 'dashed '), (I = !1))
			y.setAttribute('columnalign', k.trim()),
				/[sd]/.test(D) && y.setAttribute('columnlines', D.trim())
		}
		if (e.colSeparationType === 'align') {
			for (var Z = e.cols || [], Y = '', K = 1; K < Z.length; K++)
				Y += K % 2 ? '0em ' : '1em '
			y.setAttribute('columnspacing', Y.trim())
		} else
			e.colSeparationType === 'alignat' || e.colSeparationType === 'gather'
				? y.setAttribute('columnspacing', '0em')
				: e.colSeparationType === 'small'
				? y.setAttribute('columnspacing', '0.2778em')
				: e.colSeparationType === 'CD'
				? y.setAttribute('columnspacing', '0.5em')
				: y.setAttribute('columnspacing', '1em')
		var j = '',
			t0 = e.hLinesBeforeRow
		;(B += t0[0].length > 0 ? 'left ' : ''), (B += t0[t0.length - 1].length > 0 ? 'right ' : '')
		for (var J = 1; J < t0.length - 1; J++)
			j += t0[J].length === 0 ? 'none ' : t0[J][0] ? 'dashed ' : 'solid '
		return (
			/[sd]/.test(j) && y.setAttribute('rowlines', j.trim()),
			B !== '' &&
				((y = new T.MathNode('menclose', [y])), y.setAttribute('notation', B.trim())),
			e.arraystretch &&
				e.arraystretch < 1 &&
				((y = new T.MathNode('mstyle', [y])), y.setAttribute('scriptlevel', '1')),
			y
		)
	},
	R1 = function (e, t) {
		e.envName.indexOf('ed') === -1 && Zr(e)
		var a = [],
		...
		if (t[0] && t[0].type === 'ordgroup') {
			for (var y = '', b = 0; b < t[0].body.length; b++) {
				var B = X(t[0].body[b], 'textord')
				y += B.text
			}
			;(h = Number(y)), (m = h * 2)
		}
		...
		o.body.forEach(function (N) {
			for (var P = 1; P < N.length; P += 2) {
				var U = X(N[P], 'styling'),
					Z = X(U.body[0], 'ordgroup')
				Z.body.unshift(v)
			}
			if (k) m < N.length && (m = N.length)
			else {
				var Y = N.length / 2
				if (h < Y)
					throw new z(
						'Too many math in a row: ' + ('expected ' + h + ', but got ' + Y),
						N[0]
					)
			}
		})
		for (var C = 0; C < m; ++C) {
			var D = 'r',
				I = 0
			C % 2 === 1 ? (D = 'l') : C > 0 && k && (I = 1),
				(a[C] = { type: 'align', align: D, pregap: I, postgap: 0 })
		}
	...
	handler(r, e) {
		var t = Xr(e[0]),
			...
			n = a.map(function (o) {
				...
				if (m === ':') return { type: 'separator', separator: ':' }
				throw new z('Unknown column alignment: ' + m, o)
			}),
			l = { cols: n, hskipBeforeAndAfter: !0, maxNumCols: n.length }
		return we(r.parser, l, La(r.envName))
	},
	htmlBuilder: ee,
	mathmlBuilder: te
})
Q0({
	...
	handler(r) {
		...
		var l = we(r.parser, a, La(r.envName)),
			o = Math.max(0, ...l.body.map((h) => h.length))
		return (
			(l.cols = new Array(o).fill({ type: 'align', align: t })),
			e
				? {
						type: 'leftright',
						mode: r.mode,
...
Q0({
	...
	handler(r, e) {
		...
		if (((l = we(r.parser, l, 'script')), l.body.length > 0 && l.body[0].length > 1))
...
Q0({
	...
	props: { numArgs: 0 },
	handler(r) {
		$.contains(['gather', 'gather*'], r.envName) && Zr(r)
		var e = {
...
E({
	...
	handler(r, e) {
		...
		for (var l = '', o = 0; o < n.body.length; ++o) l += X(n.body[o], 'textord').text
		if (a === '\\begin') {
			if (!Hn.hasOwnProperty(l)) throw new z('No such environment: ' + l, n)
			var h = Hn[l],
				{ args: m, optArgs: v } = t.parseArguments('\\begin{' + l + '}', h),
				y = { mode: t.mode, envName: l, parser: t },
				b = h.handler(y, m, v)
			t.expect('\\end', !1)
			var B = t.nextToken,
				k = X(t.parseFunction(), 'environment')
			if (k.name !== l)
				throw new z('Mismatch: \\begin{' + l + '} matched by \\end{' + k.name + '}', B)
			return b
		}
...
E({
	...
	handler: (r, e) => {
		var { parser: t, funcName: a } = r,
			n = Vr(e[0]),
			l = a
		return l in Rn && (l = Rn[l]), { type: 'font', mode: t.mode, font: l.slice(1), body: n }
	},
	htmlBuilder: L1,
	mathmlBuilder: O1
})
...
E({
	...
	handler: (r, e) => {
		var { parser: t, funcName: a, breakOnTokenText: n } = r,
			...
			h = 'math' + a.slice(1)
		return { type: 'font', mode: l, font: h, body: { type: 'ordgroup', mode: t.mode, body: o } }
	},
	htmlBuilder: L1,
	mathmlBuilder: O1
})
var P1 = (r, e) => {
		...
		return (
			r === 'display'
				? (t = t.id >= O.SCRIPT.id ? t.text() : O.DISPLAY)
				: r === 'text' && t.size === O.DISPLAY.size
				? (t = O.TEXT)
				: r === 'script'
				? (t = O.SCRIPT)
				: r === 'scriptscript' && (t = O.SCRIPTSCRIPT),
			t
		)
	},
	Oa = (r, e) => {
		var t = P1(r.size, e.style),
			a = t.fracNum(),
			n = t.fracDen(),
			l
		l = e.havingStyle(a)
		...
		r.hasBarLine
			? (r.barSize
					? ((b = l0(r.barSize, e)), (y = x.makeLineSpan('frac-line', e, b)))
					: (y = x.makeLineSpan('frac-line', e)),
			  (b = y.height),
			  (B = y.height))
			: ((y = null), (b = 0), (B = e.fontMetrics().defaultRuleThickness))
		var k, C, D
		t.size === O.DISPLAY.size || r.size === 'display'
			? ((k = e.fontMetrics().num1),
			  b > 0 ? (C = 3 * B) : (C = 7 * B),
			  (D = e.fontMetrics().denom1))
			: (b > 0
					? ((k = e.fontMetrics().num2), (C = B))
					: ((k = e.fontMetrics().num3), (C = 3 * B)),
			  (D = e.fontMetrics().denom2))
		var I
		if (y) {
			var P = e.fontMetrics().axisHeight
			k - o.depth - (P + 0.5 * b) < C && (k += C - (k - o.depth - (P + 0.5 * b))),
				P - 0.5 * b - (v.height - D) < C && (D += C - (P - 0.5 * b - (v.height - D)))
			var U = -(P - 0.5 * b)
			I = x.makeVList(
				{
					positionType: 'individualShift',
					children: [
						{ type: 'elem', elem: v, shift: D },
						{ type: 'elem', elem: y, shift: U },
			...
			var N = k - o.depth - (v.height - D)
			N < C && ((k += 0.5 * (C - N)), (D += 0.5 * (C - N))),
				(I = x.makeVList(
					{
						positionType: 'individualShift',
						children: [
		...
		;(l = e.havingStyle(t)),
			(I.height *= l.sizeMultiplier / e.sizeMultiplier),
			(I.depth *= l.sizeMultiplier / e.sizeMultiplier)
		var Z
		t.size === O.DISPLAY.size
			? (Z = e.fontMetrics().delim1)
			: t.size === O.SCRIPTSCRIPT.size
			? (Z = e.havingStyle(O.SCRIPT).fontMetrics().delim2)
			: (Z = e.fontMetrics().delim2)
		var Y, K
		return (
			r.leftDelim == null
				? (Y = Gt(e, ['mopen']))
				: (Y = ie.customSizedDelim(r.leftDelim, Z, !0, e.havingStyle(t), r.mode, [
						'mopen'
				  ])),
			r.continued
				? (K = x.makeSpan([]))
				: r.rightDelim == null
				? (K = Gt(e, ['mclose']))
				: (K = ie.customSizedDelim(r.rightDelim, Z, !0, e.havingStyle(t), r.mode, [
						'mclose'
				  ])),
			x.makeSpan(['mord'].concat(l.sizingClasses(e)), [Y, x.makeSpan(['mfrac'], [I]), K], e)
		)
	},
	Pa = (r, e) => {
		var t = new T.MathNode('mfrac', [e0(r.numer, e), e0(r.denom, e)])
		if (!r.hasBarLine) t.setAttribute('linethickness', '0px')
		else if (r.barSize) {
			var a = l0(r.barSize, e)
			t.setAttribute('linethickness', F(a))
		}
		var n = P1(r.size, e.style)
		if (n.size !== e.style.size) {
			t = new T.MathNode('mstyle', [t])
			var l = n.size === O.DISPLAY.size ? 'true' : 'false'
			t.setAttribute('displaystyle', l), t.setAttribute('scriptlevel', '0')
		}
		if (r.leftDelim != null || r.rightDelim != null) {
			var o = []
			if (r.leftDelim != null) {
				var h = new T.MathNode('mo', [new T.TextNode(r.leftDelim.replace('\\', ''))])
				h.setAttribute('fence', 'true'), o.push(h)
			}
			if ((o.push(t), r.rightDelim != null)) {
				var m = new T.MathNode('mo', [new T.TextNode(r.rightDelim.replace('\\', ''))])
...
E({
	...
	handler(r, e) {
		var { parser: t } = r,
			...
			n = e[5],
			l = Vr(e[0]),
			o = l.type === 'atom' && l.family === 'open' ? On(l.text) : null,
			h = Vr(e[1]),
			m = h.type === 'atom' && h.family === 'close' ? On(h.text) : null,
			v = X(e[2], 'size'),
			y,
			b = null
		v.isBlank ? (y = !0) : ((b = v.value), (y = b.number > 0))
		var B = 'auto',
			k = e[3]
		if (k.type === 'ordgroup') {
			if (k.body.length > 0) {
				var C = X(k.body[0], 'textord')
				B = Ln[Number(C.text)]
			}
		} else (k = X(k, 'textord')), (B = Ln[Number(k.text)])
		return {
			type: 'genfrac',
			mode: t.mode,
			numer: a,
...
var G1 = (r, e) => {
		...
		r.type === 'supsub'
			? ((a = r.sup
					? Q(r.sup, e.havingStyle(t.sup()), e)
					: Q(r.sub, e.havingStyle(t.sub()), e)),
			  (n = X(r.base, 'horizBrace')))
			: (n = X(r, 'horizBrace'))
		var l = Q(n.base, e.havingBaseStyle(O.DISPLAY)),
			o = he.svgSpan(n, e),
			h
		if (
			(n.isOver
	...
	Ul = (r, e) => {
		var t = he.mathMLnode(r.label)
		return new T.MathNode(r.isOver ? 'mover' : 'munder', [e0(r.base, e), t])
	}
E({
	type: 'horizBrace',
...
E({
	...
	handler: (r, e) => {
		...
		return t.settings.isTrusted({ command: '\\href', url: n })
			? { type: 'href', mode: t.mode, href: n, body: o0(a) }
	...
	mathmlBuilder: (r, e) => {
		var t = xe(r.body, e)
		return t instanceof R0 || (t = new R0('mrow', [t])), t.setAttribute('href', r.href), t
	}
})
E({
	type: 'href',
	...
	handler: (r, e) => {
		...
		return { type: 'href', mode: t.mode, href: a, body: o0(h) }
	}
})
E({
	type: 'hbox',
	...
	handler(r, e) {
		var { parser: t } = r
		return { type: 'hbox', mode: t.mode, body: o0(e[0]) }
	},
	htmlBuilder(r, e) {
		var t = h0(r.body, e, !1)
		return x.makeFragment(t)
	...
	mathmlBuilder(r, e) {
		return new T.MathNode('mrow', S0(r.body, e))
	}
})
E({
	type: 'html',
	...
	handler: (r, e) => {
		...
		switch (a) {
			case '\\htmlClass':
				;(m.class = l), (h = { command: '\\htmlClass', class: l })
				break
			case '\\htmlId':
				;(m.id = l), (h = { command: '\\htmlId', id: l })
				break
			case '\\htmlStyle':
				;(m.style = l), (h = { command: '\\htmlStyle', style: l })
				break
			case '\\htmlData': {
				for (var v = l.split(','), y = 0; y < v.length; y++) {
					var b = v[y].split('=')
					if (b.length !== 2) throw new z('Error parsing key-value for \\htmlData')
		...
		return t.settings.isTrusted(h)
			? { type: 'html', mode: t.mode, attributes: m, body: o0(o) }
...
E({
	...
	handler: (r, e) => {
		var { parser: t } = r
		return { type: 'htmlmathml', mode: t.mode, html: o0(e[0]), mathml: o0(e[1]) }
	},
	htmlBuilder: (r, e) => {
		var t = h0(r.html, e, !1)
		return x.makeFragment(t)
	},
	mathmlBuilder: (r, e) => xe(r.mathml, e)
})
var ma = function (e) {
	...
	if (!l1(a)) throw new z("Invalid unit: '" + a.unit + "' in \\includegraphics.")
	return a
}
E({
	...
	handler: (r, e, t) => {
		var { parser: a } = r,
			...
			h = ''
		if (t[0])
			for (var m = X(t[0], 'raw').string, v = m.split(','), y = 0; y < v.length; y++) {
				var b = v[y].split('=')
				if (b.length === 2) {
					var B = b[1].trim()
					switch (b[0].trim()) {
		...
		return (
			...
			a.settings.isTrusted({ command: '\\includegraphics', url: k })
				? {
						type: 'includegraphics',
						mode: a.mode,
						alt: h,
	...
	htmlBuilder: (r, e) => {
		var t = l0(r.height, e),
			a = 0
		r.totalheight.number > 0 && (a = l0(r.totalheight, e) - t)
		var n = 0
		r.width.number > 0 && (n = l0(r.width, e))
		var l = { height: F(t + a) }
		n > 0 && (l.width = F(n)), a > 0 && (l.verticalAlign = F(-a))
		var o = new Us(r.src, r.alt, l)
	...
	mathmlBuilder: (r, e) => {
		...
		if (
			(r.totalheight.number > 0 &&
				((n = l0(r.totalheight, e) - a), t.setAttribute('valign', F(-n))),
			t.setAttribute('height', F(a + n)),
			r.width.number > 0)
		) {
			var l = l0(r.width, e)
			t.setAttribute('width', F(l))
		}
...
E({
	...
	htmlBuilder: (r, e) => {
		var t
		r.alignment === 'clap'
			? ((t = x.makeSpan([], [Q(r.body, e)])), (t = x.makeSpan(['inner'], [t], e)))
			: (t = x.makeSpan(['inner'], [Q(r.body, e)]))
		var a = x.makeSpan(['fix'], []),
			n = x.makeSpan([r.alignment], [t, a], e),
			l = x.makeSpan(['strut'])
		return (
			(l.style.height = F(n.height + n.depth)),
			n.depth && (l.style.verticalAlign = F(-n.depth)),
			n.children.unshift(l),
			(n = x.makeSpan(['thinbox'], [n], e)),
			x.makeSpan(['mord', 'vbox'], [n], e)
		)
	},
	mathmlBuilder: (r, e) => {
		var t = new T.MathNode('mpadded', [e0(r.body, e)])
		if (r.alignment !== 'rlap') {
...
E({
	...
	handler(r, e) {
		...
		a.switchMode('math')
		var l = t === '\\(' ? '\\)' : '$',
			o = a.parseExpression(!1, l)
		return (
			a.expect(l), a.switchMode(n), { type: 'styling', mode: a.mode, style: 'text', body: o }
		)
	}
})
E({
...
var $1 = (r, e, t, a, n, l, o) => {
		r = x.makeSpan([], [r])
		var h = t && $.isCharacterBox(t),
			m,
			v
		if (e) {
			var y = Q(e, a.havingStyle(n.sup()), a)
			v = {
				elem: y,
				kern: Math.max(
					a.fontMetrics().bigOpSpacing1,
					a.fontMetrics().bigOpSpacing3 - y.depth
				)
			}
		}
		if (t) {
			var b = Q(t, a.havingStyle(n.sub()), a)
			m = {
				elem: b,
				kern: Math.max(
					a.fontMetrics().bigOpSpacing2,
					a.fontMetrics().bigOpSpacing4 - b.height
				)
			}
		}
		var B
		if (v && m) {
			var k =
				a.fontMetrics().bigOpSpacing5 + m.elem.height + m.elem.depth + m.kern + r.depth + o
			B = x.makeVList(
				{
					positionType: 'bottom',
					positionData: k,
					children: [
						...
						{ type: 'elem', elem: m.elem, marginLeft: F(-l) },
						{ type: 'kern', size: m.kern },
						{ type: 'elem', elem: r },
						{ type: 'kern', size: v.kern },
						{ type: 'elem', elem: v.elem, marginLeft: F(l) },
						{ type: 'kern', size: a.fontMetrics().bigOpSpacing5 }
					]
				},
				a
		...
		var I = [B]
		if (m && l !== 0 && !h) {
			var N = x.makeSpan(['mspace'], [], a)
			;(N.style.marginRight = F(l)), I.unshift(N)
		}
		return x.makeSpan(['mop', 'op-limits'], I, a)
	},
	U1 = ['\\smallint'],
	dt = (r, e) => {
		var t,
			...
			l
		r.type === 'supsub'
			? ((t = r.sup), (a = r.sub), (l = X(r.base, 'op')), (n = !0))
			: (l = X(r, 'op'))
		var o = e.style,
			h = !1
		o.size === O.DISPLAY.size && l.symbol && !$.contains(U1, l.name) && (h = !0)
		var m
		if (l.symbol) {
			...
			if (
				((l.name === '\\oiint' || l.name === '\\oiiint') &&
					((y = l.name.slice(1)), (l.name = y === 'oiint' ? '\\iint' : '\\iiint')),
				(m = x.makeSymbol(l.name, v, 'math', e, [
					'mop',
					'op-symbol',
					h ? 'large-op' : 'small-op'
				])),
			...
			var k = h0(l.body, e, !0)
			k.length === 1 && k[0] instanceof O0
				? ((m = k[0]), (m.classes[0] = 'mop'))
				: (m = x.makeSpan(['mop'], k, e))
		} else {
			for (var C = [], D = 1; D < l.name.length; D++) C.push(x.mathsym(l.name[D], l.mode, e))
			m = x.makeSpan(['mop'], C, e)
		}
		var I = 0,
			N = 0
		return (
			(m instanceof O0 || l.name === '\\oiint' || l.name === '\\oiiint') &&
				!l.suppressBaseShift &&
				((I = (m.height - m.depth) / 2 - e.fontMetrics().axisHeight), (N = m.italic)),
			n
				? $1(m, t, a, e, o, N, I)
				: (I && ((m.style.position = 'relative'), (m.style.top = F(I))), m)
		)
	},
	_t = (r, e) => {
		var t
		if (r.symbol)
			(t = new R0('mo', [P0(r.name, r.mode)])),
				$.contains(U1, r.name) && t.setAttribute('largeop', 'false')
		else if (r.body) t = new R0('mo', S0(r.body, e))
		else {
			t = new R0('mi', [new Lt(r.name.slice(1))])
			var a = new R0('mo', [P0('⁡', 'text')])
			r.parentIsSupSub ? (t = new R0('mrow', [t, a])) : (t = g1([t, a]))
		}
		return t
	},
	Vl = {
...
E({
	...
	handler: (r, e) => {
		var { parser: t } = r,
			a = e[0]
		return { type: 'op', mode: t.mode, limits: !1, parentIsSupSub: !1, symbol: !1, body: o0(a) }
	},
	htmlBuilder: dt,
	mathmlBuilder: _t
})
...
var V1 = (r, e) => {
		var t,
			...
			l
		r.type === 'supsub'
			? ((t = r.sup), (a = r.sub), (l = X(r.base, 'operatorname')), (n = !0))
			: (l = X(r, 'operatorname'))
		var o
		if (l.body.length > 0) {
			for (
				var h = l.body.map((b) => {
						var B = b.text
						return typeof B == 'string' ? { type: 'textord', mode: b.mode, text: B } : b
					}),
					m = h0(h, e.withFont('mathrm'), !0),
					v = 0;
				v < m.length;
				v++
			) {
				var y = m[v]
				y instanceof O0 && (y.text = y.text.replace(/\u2212/, '-').replace(/\u2217/, '*'))
			}
			o = x.makeSpan(['mop'], m, e)
		} else o = x.makeSpan(['mop'], [], e)
		return n ? $1(o, t, a, e, e.style, 0, 0) : o
	},
	Wl = (r, e) => {
		for (var t = S0(r.body, e.withFont('mathrm')), a = !0, n = 0; n < t.length; n++) {
			var l = t[n]
			if (!(l instanceof T.SpaceNode))
				if (l instanceof T.MathNode)
					switch (l.type) {
						case 'mi':
						case 'mn':
						case 'ms':
						...
						case 'mo': {
							var o = l.children[0]
							l.children.length === 1 && o instanceof T.TextNode
		...
		if (a) {
			var h = t.map((y) => y.toText()).join('')
			t = [new T.TextNode(h)]
		}
		var m = new T.MathNode('mi', t)
		m.setAttribute('mathvariant', 'normal')
		var v = new T.MathNode('mo', [P0('⁡', 'text')])
		return r.parentIsSupSub ? new T.MathNode('mrow', [m, v]) : T.newDocumentFragment([m, v])
	}
E({
	type: 'operatorname',
...
lt({
	...
	htmlBuilder(r, e) {
		return r.semisimple
			? x.makeFragment(h0(r.body, e, !1))
			: x.makeSpan(['mord'], h0(r.body, e, !0), e)
	},
	mathmlBuilder(r, e) {
		return xe(r.body, e, !0)
	}
})
E({
	type: 'overline',
	...
	htmlBuilder(r, e) {
		var t = Q(r.body, e.havingCrampedStyle()),
			a = x.makeLineSpan('overline-line', e),
	...
	mathmlBuilder(r, e) {
		...
		t.setAttribute('stretchy', 'true')
		var a = new T.MathNode('mover', [e0(r.body, e), t])
		return a.setAttribute('accent', 'true'), a
	}
})
E({
	...
	handler: (r, e) => {
		var { parser: t } = r,
			a = e[0]
		return { type: 'phantom', mode: t.mode, body: o0(a) }
	},
	htmlBuilder: (r, e) => {
		var t = h0(r.body, e.withPhantom(), !1)
		return x.makeFragment(t)
	},
	mathmlBuilder: (r, e) => {
		var t = S0(r.body, e)
...
E({
	...
	htmlBuilder: (r, e) => {
		var t = x.makeSpan([], [Q(r.body, e.withPhantom())])
	...
	mathmlBuilder: (r, e) => {
		var t = S0(o0(r.body), e),
			a = new T.MathNode('mphantom', t),
			n = new T.MathNode('mpadded', [a])
...
E({
	...
	htmlBuilder: (r, e) => {
		var t = x.makeSpan(['inner'], [Q(r.body, e.withPhantom())]),
			a = x.makeSpan(['fix'], [])
...
E({
	...
	handler(r, e, t) {
		...
		return {
			type: 'rule',
			mode: a.mode,
			shift: n && X(n, 'size').value,
			width: l.value,
			height: o.value
		}
	},
	htmlBuilder(r, e) {
		var t = x.makeSpan(['mord', 'rule'], [], e),
			a = l0(r.width, e),
			n = l0(r.height, e),
			l = r.shift ? l0(r.shift, e) : 0
		return (
			(t.style.borderRightWidth = F(a)),
			(t.style.borderTopWidth = F(n)),
			(t.style.bottom = F(l)),
			(t.width = a),
			(t.height = n + l),
			(t.depth = -l),
	...
	mathmlBuilder(r, e) {
		var t = l0(r.width, e),
			a = l0(r.height, e),
			n = r.shift ? l0(r.shift, e) : 0,
			l = (e.color && e.getColor()) || 'black',
			o = new T.MathNode('mspace')
		o.setAttribute('mathbackground', l),
			o.setAttribute('width', F(t)),
			o.setAttribute('height', F(a))
		var h = new T.MathNode('mpadded', [o])
		return (
			n >= 0
				? h.setAttribute('height', F(n))
				: (h.setAttribute('height', F(n)), h.setAttribute('depth', F(-n))),
			h.setAttribute('voffset', F(n)),
			h
		)
	}
})
function _1(r, e, t) {
	for (var a = h0(r, e, !1), n = e.sizeMultiplier / t.sizeMultiplier, l = 0; l < a.length; l++) {
		var o = a[l].classes.indexOf('sizing')
		o < 0
			? Array.prototype.push.apply(a[l].classes, e.sizingClasses(t))
			: a[l].classes[o + 1] === 'reset-size' + e.size &&
			  (a[l].classes[o + 1] = 'reset-size' + t.size),
			(a[l].height *= n),
			(a[l].depth *= n)
	}
	return x.makeFragment(a)
...
E({
	...
	handler: (r, e) => {
		...
		return { type: 'sizing', mode: n.mode, size: Gn.indexOf(a) + 1, body: l }
	},
	htmlBuilder: Xl,
	mathmlBuilder: (r, e) => {
		var t = e.havingSize(r.size),
			a = S0(r.body, t),
			n = new T.MathNode('mstyle', a)
		return n.setAttribute('mathsize', F(t.sizeMultiplier)), n
	}
})
E({
	type: 'smash',
	...
	handler: (r, e, t) => {
		...
		var y = e[0]
		return { type: 'smash', mode: a.mode, body: y, smashHeight: n, smashDepth: l }
	},
	htmlBuilder: (r, e) => {
		var t = x.makeSpan([], [Q(r.body, e)])
...
E({
	...
	htmlBuilder(r, e) {
		...
		var a = e.fontMetrics(),
			...
			l = n
		e.style.id < O.TEXT.id && (l = e.fontMetrics().xHeight)
		var o = n + l / 4,
			h = t.height + t.depth + o + n,
			{ span: m, ruleWidth: v, advanceWidth: y } = ie.sqrtImage(h, e),
			b = m.height - v
		b > t.height + t.depth + o && (o = (o + b - t.height - t.depth) / 2)
		var B = m.height - t.height - o - v
		t.style.paddingLeft = F(y)
		var k = x.makeVList(
			{
				positionType: 'firstBaseline',
				children: [
		...
		if (r.index) {
			var C = e.havingStyle(O.SCRIPTSCRIPT),
				D = Q(r.index, C, e),
				I = 0.6 * (k.height - k.depth),
				N = x.makeVList(
					{
						positionType: 'shift',
						positionData: -I,
				...
				P = x.makeSpan(['root'], [N])
			return x.makeSpan(['mord', 'sqrt'], [P, k], e)
		} else return x.makeSpan(['mord', 'sqrt'], [k], e)
	},
	mathmlBuilder(r, e) {
		var { body: t, index: a } = r
		return a
			? new T.MathNode('mroot', [e0(t, e), e0(a, e)])
			: new T.MathNode('msqrt', [e0(t, e)])
	}
})
var $n = { display: O.DISPLAY, text: O.TEXT, script: O.SCRIPT, scriptscript: O.SCRIPTSCRIPT }
E({
	type: 'styling',
	...
	handler(r, e) {
		...
		return { type: 'styling', mode: n.mode, style: o, body: l }
	},
	htmlBuilder(r, e) {
		var t = $n[r.style],
			a = e.havingStyle(t).withFont('')
		return _1(r.body, a, e)
	},
	mathmlBuilder(r, e) {
		var t = $n[r.style],
			a = e.havingStyle(t),
			n = S0(r.body, a),
			l = new T.MathNode('mstyle', n),
			o = {
				display: ['0', 'true'],
				text: ['0', 'false'],
				script: ['1', 'false'],
...
var Yl = function (e, t) {
	...
	if (a)
		if (a.type === 'op') {
			var n = a.limits && (t.style.size === O.DISPLAY.size || a.alwaysHandleSupSub)
			return n ? dt : null
		} else if (a.type === 'operatorname') {
			var l = a.alwaysHandleSupSub && (t.style.size === O.DISPLAY.size || a.limits)
			return l ? V1 : null
		} else {
			if (a.type === 'accent') return $.isCharacterBox(a.base) ? Na : null
			if (a.type === 'horizBrace') {
				var o = !e.sub
				return o === a.isOver ? G1 : null
			} else return null
		}
	else return null
}
lt({
	...
	htmlBuilder(r, e) {
		...
		var { base: a, sup: n, sub: l } = r,
			...
			y = 0,
			b = 0,
			B = a && $.isCharacterBox(a)
		if (n) {
			var k = e.havingStyle(e.style.sup())
			;(h = Q(n, k, e)),
				B ||
					(y = o.height - (k.fontMetrics().supDrop * k.sizeMultiplier) / e.sizeMultiplier)
		}
		if (l) {
			var C = e.havingStyle(e.style.sub())
			;(m = Q(l, C, e)),
				B || (b = o.depth + (C.fontMetrics().subDrop * C.sizeMultiplier) / e.sizeMultiplier)
		}
		var D
		e.style === O.DISPLAY ? (D = v.sup1) : e.style.cramped ? (D = v.sup3) : (D = v.sup2)
		var I = e.sizeMultiplier,
			N = F(0.5 / v.ptPerEm / I),
			P = null
		if (m) {
			var U =
			...
			;(o instanceof O0 || U) && (P = F(-o.italic))
		}
		var Z
		if (h && m) {
			;(y = Math.max(y, D, h.depth + 0.25 * v.xHeight)), (b = Math.max(b, v.sub2))
			var Y = v.defaultRuleThickness,
				K = 4 * Y
			if (y - h.depth - (m.height - b) < K) {
				b = K - (y - h.depth) + m.height
				var j = 0.8 * v.xHeight - (y - h.depth)
				j > 0 && ((y += j), (b -= j))
			}
			var t0 = [
				{ type: 'elem', elem: m, shift: b, marginRight: N, marginLeft: P },
				{ type: 'elem', elem: h, shift: -y, marginRight: N }
			]
			Z = x.makeVList({ positionType: 'individualShift', children: t0 }, e)
		} else if (m) {
			b = Math.max(b, v.sub1, m.height - 0.8 * v.xHeight)
			var J = [{ type: 'elem', elem: m, marginLeft: P, marginRight: N }]
			Z = x.makeVList({ positionType: 'shift', positionData: b, children: J }, e)
		} else if (h)
			(y = Math.max(y, D, h.depth + 0.25 * v.xHeight)),
				(Z = x.makeVList(
					{
						positionType: 'shift',
						positionData: -y,
		...
		var c0 = xa(o, 'right') || 'mord'
		return x.makeSpan([c0], [o, x.makeSpan(['msupsub'], [Z])], e)
	},
	mathmlBuilder(r, e) {
		var t = !1,
			a,
		...
		var l = [e0(r.base, e)]
		r.sub && l.push(e0(r.sub, e)), r.sup && l.push(e0(r.sup, e))
		var o
		if (t) o = a ? 'mover' : 'munder'
		else if (r.sub)
			if (r.sup) {
				var v = r.base
				;(v && v.type === 'op' && v.limits && e.style === O.DISPLAY) ||
				(v &&
					v.type === 'operatorname' &&
					v.alwaysHandleSupSub &&
					(e.style === O.DISPLAY || v.limits))
					? (o = 'munderover')
					: (o = 'msubsup')
			} else {
				var m = r.base
				;(m &&
					m.type === 'op' &&
					m.limits &&
					(e.style === O.DISPLAY || m.alwaysHandleSupSub)) ||
				(m &&
					m.type === 'operatorname' &&
					m.alwaysHandleSupSub &&
					(m.limits || e.style === O.DISPLAY))
					? (o = 'munder')
					: (o = 'msub')
			}
		else {
			...
			;(h &&
				h.type === 'op' &&
				h.limits &&
				(e.style === O.DISPLAY || h.alwaysHandleSupSub)) ||
			(h &&
				h.type === 'operatorname' &&
				h.alwaysHandleSupSub &&
				(h.limits || e.style === O.DISPLAY))
				? (o = 'mover')
				: (o = 'msup')
		}
		return new T.MathNode(o, l)
	}
})
lt({
	type: 'atom',
	...
	mathmlBuilder(r, e) {
		var t = new T.MathNode('mo', [P0(r.text, r.mode)])
		if (r.family === 'bin') {
			var a = Fa(r, e)
...
var W1 = { mi: 'italic', mn: 'normal', mtext: 'normal' }
lt({
	type: 'mathord',
	htmlBuilder(r, e) {
	...
	mathmlBuilder(r, e) {
		var t = new T.MathNode('mi', [P0(r.text, r.mode, e)]),
			a = Fa(r, e) || 'italic'
		return a !== W1[t.type] && t.setAttribute('mathvariant', a), t
	}
})
lt({
	type: 'textord',
	...
	mathmlBuilder(r, e) {
		var t = P0(r.text, r.mode, e),
			a = Fa(r, e) || 'normal',
			n
		return (
			r.mode === 'text'
				? (n = new T.MathNode('mtext', [t]))
				: /[0-9]/.test(r.text)
				? (n = new T.MathNode('mn', [t]))
				: r.text === '\\prime'
				? (n = new T.MathNode('mo', [t]))
				: (n = new T.MathNode('mi', [t])),
			a !== W1[n.type] && n.setAttribute('mathvariant', a),
			n
		)
	}
})
...
lt({
	type: 'spacing',
	htmlBuilder(r, e) {
		if (pa.hasOwnProperty(r.text)) {
			var t = pa[r.text].className || ''
			if (r.mode === 'text') {
				var a = x.makeOrd(r, e, 'textord')
				return a.classes.push(t), a
			} else return x.makeSpan(['mspace', t], [x.mathsym(r.text, r.mode, e)], e)
		} else {
			if (ca.hasOwnProperty(r.text)) return x.makeSpan(['mspace', ca[r.text]], [], e)
			throw new z('Unknown type of space "' + r.text + '"')
		}
	},
	mathmlBuilder(r, e) {
		var t
		if (pa.hasOwnProperty(r.text)) t = new T.MathNode('mtext', [new T.TextNode(' ')])
		else {
			if (ca.hasOwnProperty(r.text)) return new T.MathNode('mspace')
			throw new z('Unknown type of space "' + r.text + '"')
		}
		return t
	}
...
lt({
	type: 'tag',
	mathmlBuilder(r, e) {
		var t = new T.MathNode('mtable', [
			new T.MathNode('mtr', [
				Un(),
				new T.MathNode('mtd', [xe(r.body, e)]),
				Un(),
				new T.MathNode('mtd', [xe(r.tag, e)])
			])
		])
...
var Vn = {
	...
	_n = { '\\textbf': 'textbf', '\\textmd': 'textmd' },
	jl = { '\\textit': 'textit', '\\textup': 'textup' },
	Wn = (r, e) => {
		var t = r.font
		return t
			? Vn[t]
				? e.withTextFontFamily(Vn[t])
				: _n[t]
				? e.withTextFontWeight(_n[t])
				: e.withTextFontShape(jl[t])
			: e
	}
E({
	type: 'text',
	...
	handler(r, e) {
		var { parser: t, funcName: a } = r,
			n = e[0]
		return { type: 'text', mode: t.mode, body: o0(n), font: a }
	},
	htmlBuilder(r, e) {
		var t = Wn(r, e),
			a = h0(r.body, t, !0)
...
E({
	...
	htmlBuilder(r, e) {
		var t = Q(r.body, e),
			a = x.makeLineSpan('underline-line', e),
			n = e.fontMetrics().defaultRuleThickness,
			l = x.makeVList(
				{
					positionType: 'top',
	...
	mathmlBuilder(r, e) {
		var t = new T.MathNode('mo', [new T.TextNode('‾')])
		t.setAttribute('stretchy', 'true')
		var a = new T.MathNode('munder', [e0(r.body, e), t])
		return a.setAttribute('accentunder', 'true'), a
	}
})
E({
	...
	mathmlBuilder(r, e) {
		return new T.MathNode('mpadded', [e0(r.body, e)], ['vcenter'])
	}
})
E({
	type: 'verb',
	...
	htmlBuilder(r, e) {
		for (var t = Xn(r), a = [], n = e.havingStyle(e.style.text()), l = 0; l < t.length; l++) {
			var o = t[l]
			o === '~' && (o = '\\textasciitilde'),
				a.push(x.makeSymbol(o, 'Typewriter-Regular', r.mode, n, ['mord', 'texttt']))
		}
		return x.makeSpan(['mord', 'text'].concat(n.sizingClasses(e)), x.tryCombineChars(a), n)
	},
	mathmlBuilder(r, e) {
		var t = new T.TextNode(Xn(r)),
			a = new T.MathNode('mtext', [t])
		return a.setAttribute('mathvariant', 'monospace'), a
	}
})
var Xn = (r) => r.body.replace(/ /g, r.star ? '␣' : ' '),
	ge = f1,
	X1 = `[ \r
	]`,
	Zl = '\\\\[a-zA-Z@]+',
...
class Yn {
	constructor(e, t) {
		;(this.input = void 0),
			...
			(this.input = e),
			(this.settings = t),
			(this.tokenRegex = new RegExp(ti, 'g')),
			(this.catcodes = { '%': 14, '~': 13 })
	}
	setCatcode(e, t) {
		this.catcodes[e] = t
	...
	lex() {
		...
		if (t === e.length) return new J0('EOF', new M0(this, t, t))
		var a = this.tokenRegex.exec(e)
		if (a === null || a.index !== t)
			throw new z(
				"Unexpected character: '" + e[t] + "'",
				new J0(e[t], new M0(this, t, t + 1))
			)
		var n = a[6] || a[3] || (a[2] ? '\\ ' : ' ')
...
`,
		...
		return new J0(n, new M0(this, t, this.tokenRegex.lastIndex))
	}
}
class ri {
	constructor(e, t) {
...
c('\\char', function (r) {
	...
	if (t) {
		...
		for (var n; (n = jn[r.future().text]) != null && n < t; ) (a *= t), (a += n), r.popToken()
	}
	return '\\@char{' + a + '}'
})
var Ga = (r, e, t) => {
...
c('\\newcommand', (r) => Ga(r, !1, !0))
c('\\renewcommand', (r) => Ga(r, !0, !1))
c('\\providecommand', (r) => Ga(r, !0, !0))
c('\\message', (r) => {
...
c('\\show', (r) => {
	var e = r.popToken(),
		t = e.text
	return console.log(e, r.macros.get(t), ge[t], r0.math[t], r0.text[t]), ''
})
c('\\bgroup', '{')
c('\\egroup', '}')
c('~', '\\nobreakspace')
...
c('\\dots', function (r) {
	...
	return (
		t in Zn
			? (e = Zn[t])
			: (t.slice(0, 4) === '\\not' ||
					(t in r0.math && $.contains(['bin', 'rel'], r0.math[t].group))) &&
			  (e = '\\dotsb'),
		e
	)
})
...
c('\\dotso', function (r) {
	var e = r.future().text
	return e in $a ? '\\ldots\\,' : '\\ldots'
})
c('\\dotsc', function (r) {
	var e = r.future().text
	return e in $a && e !== ',' ? '\\ldots\\,' : '\\ldots'
})
c('\\cdots', function (r) {
	var e = r.future().text
	return e in $a ? '\\@cdots\\,' : '\\@cdots'
})
c('\\dotsb', '\\cdots')
c('\\dotsm', '\\cdots')
c('\\dotsi', '\\!\\cdots')
...
var Y1 = F(
	K0['Main-Regular']['T'.charCodeAt(0)][1] - 0.7 * K0['Main-Regular']['A'.charCodeAt(0)][1]
)
c(
	'\\LaTeX',
	'\\textrm{\\html@mathml{' +
		('L\\kern-.36em\\raisebox{' + Y1 + '}{\\scriptstyle A}') +
		'\\kern-.15em\\TeX}{LaTeX}}'
)
c(
	'\\KaTeX',
	'\\textrm{\\html@mathml{' +
		('K\\kern-.17em\\raisebox{' + Y1 + '}{\\scriptstyle A}') +
		'\\kern-.15em\\TeX}{KaTeX}}'
)
...
var j1 = (r) => (e) => {
	...
	e.macros.beginGroup()
	var m = (b) => (B) => {
		r && (B.macros.set('|', o), n.length && B.macros.set('\\|', h))
		var k = b
		if (!b && n.length) {
			var C = B.future()
			C.text === '|' && (B.popToken(), (k = !0))
		}
		return { tokens: k ? n : a, numArgs: 0 }
	}
	e.macros.set('|', m(!1)), n.length && e.macros.set('\\|', m(!0))
	var v = e.consumeArg().tokens,
		y = e.expandTokens([...l, ...v, ...t])
	return e.macros.endGroup(), { tokens: y.reverse(), numArgs: 0 }
}
c('\\bra@ket', j1(!1))
c('\\bra@set', j1(!0))
c(
...
class ni {
	constructor(e, t, a) {
		;(this.settings = void 0),
			...
			this.feed(e),
			(this.macros = new ri(ai, t.macros)),
			(this.mode = a),
			(this.stack = [])
	}
	feed(e) {
	...
	scanArgument(e) {
		...
		return this.pushToken(new J0('EOF', a.loc)), this.pushTokens(n), t.range(a, '')
	}
	consumeSpaces() {
		for (;;) {
			var e = this.future()
	...
	consumeArg(e) {
		...
		var n = this.future(),
			...
			h = 0
		do {
			if (((l = this.popToken()), t.push(l), l.text === '{')) ++o
			else if (l.text === '}') {
				if ((--o, o === -1)) throw new z('Extra }', l)
			} else if (l.text === 'EOF')
				throw new z(
	...
	consumeArgs(e, t) {
		if (t) {
			...
			for (var a = t[0], n = 0; n < a.length; n++) {
				var l = this.popToken()
				if (a[n] !== l.text) throw new z("Use of the macro doesn't match its definition", l)
			}
		}
		...
		if (n.numArgs) {
			...
			for (var h = l.length - 1; h >= 0; --h) {
				...
				if (m.text === '#') {
					...
					if (((m = l[--h]), m.text === '#')) l.splice(h + 1, 1)
					else if (/^[1-9]$/.test(m.text)) l.splice(h, 2, ...o[+m.text - 1])
	...
	expandMacro(e) {
		return this.macros.has(e) ? this.expandTokens([new J0(e)]) : void 0
	}
	expandTokens(e) {
		var t = [],
			a = this.stack.length
	...
	_getExpansion(e) {
		...
		if (typeof n == 'string') {
			var l = 0
			if (n.indexOf('#') !== -1)
				for (var o = n.replace(/##/g, ''); o.indexOf('#' + (l + 1)) !== -1; ) ++l
			for (var h = new Yn(n, this.settings), m = [], v = h.lex(); v.text !== 'EOF'; )
				m.push(v), (v = h.lex())
			m.reverse()
			var y = { tokens: m, numArgs: l }
			return y
		}
		return n
	}
	isDefined(e) {
		return (
			this.macros.has(e) ||
			ge.hasOwnProperty(e) ||
			r0.math.hasOwnProperty(e) ||
			r0.text.hasOwnProperty(e) ||
			Z1.hasOwnProperty(e)
		)
	}
	isExpandable(e) {
		...
		return t != null
			...
			: ge.hasOwnProperty(e) && !ge[e].primitive
	}
}
...
class $t {
	constructor(e, t) {
		;(this.mode = void 0),
			...
			(this.mode = 'math'),
			(this.gullet = new ni(e, t, this.mode)),
			(this.settings = t),
	...
	subparse(e) {
		...
		this.consume(), this.gullet.pushToken(new J0('}')), this.gullet.pushTokens(e)
	...
	parseExpression(e, t) {
		for (var a = []; ; ) {
			...
			var n = this.fetch()
			if (
				$t.endOfExpression.indexOf(n.text) !== -1 ||
				(t && n.text === t) ||
				(e && ge[n.text] && ge[n.text].infix)
			)
				break
	...
	handleInfixNodes(e) {
		...
		if (t !== -1 && a) {
			...
			h.length === 1 && h[0].type === 'ordgroup'
				? (l = h[0])
				: (l = { type: 'ordgroup', mode: this.mode, body: h }),
				m.length === 1 && m[0].type === 'ordgroup'
					? (o = m[0])
					: (o = { type: 'ordgroup', mode: this.mode, body: m })
			var v
			return (
				a === '\\\\abovefrac'
					? (v = this.callFunction(a, [l, e[t], o], []))
					: (v = this.callFunction(a, [l, o], [])),
				[v]
			)
		} else return e
	}
	...
	parseAtom(e) {
		...
		for (var a, n; ; ) {
			...
			if (l.text === '\\limits' || l.text === '\\nolimits') {
				...
				else throw new z('Limit controls must follow a math operator', l)
				this.consume()
			} else if (l.text === '^') {
				if (a) throw new z('Double superscript', l)
				a = this.handleSupSubscript('superscript')
			} else if (l.text === '_') {
				if (n) throw new z('Double subscript', l)
				...
				this.fetch().text === '^' && m.push(this.handleSupSubscript('superscript')),
					(a = { type: 'ordgroup', mode: this.mode, body: m })
			} else if (Rr[l.text]) {
				var v = Rr[l.text],
					y = Kn.test(l.text)
				for (this.consume(); ; ) {
					var b = this.fetch().text
					if (!Rr[b] || Kn.test(b) !== y) break
					this.consume(), (v += Rr[b])
				}
				var B = new $t(v, this.settings).parse()
				y
	...
	parseFunction(e, t) {
		...
		if ((this.consume(), t && t !== 'atom' && !l.allowedInArgument))
			throw new z("Got function '" + n + "' with no arguments" + (t ? ' as ' + t : ''), a)
		if (this.mode === 'text' && !l.allowedInText)
			throw new z("Can't use function '" + n + "' in text mode", a)
		if (this.mode === 'math' && l.allowedInMath === !1)
			throw new z("Can't use function '" + n + "' in math mode", a)
		var { args: o, optArgs: h } = this.parseArguments(n, l)
		return this.callFunction(n, o, h, a, e)
	}
	callFunction(e, t, a, n, l) {
		var o = { funcName: e, parser: this, token: n, breakOnTokenText: l },
			h = ge[e]
	...
	parseArguments(e, t) {
		...
		for (var n = [], l = [], o = 0; o < a; o++) {
			...
			;((t.primitive && h == null) || (t.type === 'sqrt' && o === 1 && l[0] == null)) &&
				(h = 'primitive')
	...
	parseRegexGroup(e, t) {
		for (
			var a = this.fetch(), n = a, l = '', o;
			(o = this.fetch()).text !== 'EOF' && e.test(l + o.text);

		)
			(n = o), (l += n.text), this.consume()
		if (l === '') throw new z('Invalid ' + t + ": '" + a.text + "'", a)
		return a.range(n, l)
	}
	parseColorGroup(e) {
	...
	parseSizeGroup(e) {
		...
		if (!l1(l)) throw new z("Invalid unit: '" + l.unit + "'", t)
	...
	parseArgumentGroup(e, t) {
		...
		var o = { type: 'ordgroup', mode: this.mode, loc: a.loc, body: l }
	...
	parseGroup(e, t) {
		...
		if (n === '{' || n === '\\begingroup') {
			...
			((l = this.parseFunction(t, e) || this.parseSymbol()),
			l == null && n[0] === '\\' && !Z1.hasOwnProperty(n))
		) {
	...
	parseSymbol() {
		...
		if (r0[this.mode][t]) {
			...
			var h = r0[this.mode][t].group,
				m = M0.range(e),
				v
			if (Ws.hasOwnProperty(h)) {
				var y = h
				v = { type: 'atom', mode: this.mode, family: y, loc: m, text: t }
			} else v = { type: h, mode: this.mode, loc: m, text: t }
			o = v
			...
			this.settings.strict &&
				...
				(o = { type: 'textord', mode: 'text', loc: M0.range(e), text: t })
		else return null
		if ((this.consume(), l))
			for (var b = 0; b < l[0].length; b++) {
				var B = l[0][b]
				if (!da[B]) throw new z("Unknown accent ' " + B + "'", e)
				var k = da[B][this.mode] || da[B].text
				if (!k) throw new z('Accent ' + B + ' unsupported in ' + this.mode + ' mode', e)
				o = {
					type: 'accent',
					mode: this.mode,
					loc: M0.range(e),
...
$t.endOfExpression = ['}', '\\endgroup', '\\end', '\\right', '&']
var Ua = function (e, t) {
		...
		if (
			...
			n = [{ type: 'tag', mode: 'text', body: n, tag: a.subparse([new J0('\\df@tag')]) }]
		}
		return n
	},
	K1 = function (e, t, a) {
...
var si = function (e, t) {
	...
	J1 = function (e, t, a) {
		...
		var n = x.makeSpan(['katex-error'], [new O0(t)])
		return (
	...
	Q1 = {
		...
		__renderToHTMLTree: ii,
		__setFontMetrics: Os,
		__defineSymbol: s,
		__defineFunction: E,
		__defineMacro: c,
		__domTree: { Span: Vt, Anchor: za, SymbolNode: O0, SvgNode: oe, PathNode: be, LineNode: ya }
	}
function Qn(r, e) {
	e = { wrap: !1, throwOnError: !1, ...e }
	const t = e.wrap ? r : `{${r}}`
	return Q1.renderToString(t, e)
}
function e1(r, e) {
	e = { overflowAuto: !0, throwOnError: !1, displayMode: !0, ...e }
	let t = Q1.renderToString(r, e)
	return (
		(t = e.overflowAuto
			? `<div style="overflow-x:auto;" class="mathlifier-display">${t}</div>`
			: t),
		t
	)
}
function oi(r) {
	...
	return {
		c() {
			;(e = new _0(!1)), (a = mt()), this.h()
		},
		l(n) {
			;(e = W0(n, !1)), (a = mt()), this.h()
		},
		h() {
			e.a = a
		},
...
function hi(r) {
	let e, t, a
	function n(h, m) {
		return h[1] == 'display' ? ui : oi
	}
	let l = n(r),
		o = l(r)
	return {
		c() {
			;(e = V('link')), (t = H()), o.c(), (a = mt()), this.h()
		},
		l(h) {
			const m = us('svelte-r30au3', document.head)
			;(e = _(m, 'LINK', { rel: !0, href: !0, integrity: !0, crossorigin: !0 })),
				m.forEach(S),
				(t = R(h)),
				o.l(h),
				(a = mt()),
		...
		h() {
			Mr(e, 'rel', 'stylesheet'),
				Mr(e, 'href', 'https://cdn.jsdelivr.net/npm/katex@0.12.0/dist/katex.min.css'),
				Mr(
					e,
					'integrity',
					'sha384-AfEj0r4/OFrOo5t7NnNe46zW/tFgW6x/bCJG8FqQCEo3+Aro6EYUG4+cU+KJWu/X'
				),
				Mr(e, 'crossorigin', 'anonymous')
		},
		m(h, m) {
			Ht(document.head, e), A(h, t, m), o.m(h, m), A(h, a, m)
		},
		p(h, [m]) {
			l === (l = n(h)) && o
				? o.p(h, m)
				: (o.d(1), (o = l(h)), o && (o.c(), o.m(a.parentNode, a)))
		},
		i: fa,
		o: fa,
		d(h) {
...
function mi(r, e, t) {
	...
	return (
		(r.$$set = (l) => {
			'expr' in l && t(0, (a = l.expr)), 'mode' in l && t(1, (n = l.mode))
		}),
		[a, n]
	)
}
class qt extends r1 {
	constructor(e) {
		super(), a1(this, e, mi, hi, t1, { expr: 0, mode: 1 })
	}
}
function ci(r) {
	let e,
		t = '<img src="/images/stm32/low-res/stm32.jpg" alt="STM32 Nucleo board"/>',
		a,
		n,
		l = 'Contents',
		o,
		h,
		m =
			'<li><a href="#introduction">Introduction</a></li> <li><a href="#setup">Setup</a></li> <li><a href="#blink">Blink</a></li> <li><a href="#serial-communication-with-interrupts">Serial communication with interrupts</a></li> <li><a href="#analog-waveform-generator">Analog waveform generator</a></li>',
		v,
		y,
		b,
		B,
		...
		K,
		j,
		t0 = 'What are the barriers to entry?',
		J,
		c0,
		m0 =
		...
		A0,
		it =
			'<li><strong>STM32CubeMX</strong> Graphical tool for configuring STM32 microcontrollers</li> <li><strong>GNU ARM toolchain</strong> Cross-platform toolchain for compiling C/C++ source</li> <li><strong>OpenOCD</strong> Open-source debugger software for microcontrollers</li> <li><strong>CLion</strong> JetBrains IDE for C/C++ development (optional)</li>',
		U0,
		Y0,
		re = 'STM32CubeMX',
		V0,
		...
		j0,
		ft =
			'<img src="/images/stm32/low-res/stm32cubemx_board_selector.png" alt="STM32CubeMX board selector window"/>',
		de,
		C0,
		ke =
		...
		Se,
		_a =
			'<img src="/images/stm32/low-res/stm32cubemx_pinout_config.png" alt="STM32CubeMX pin configuration window"/>',
		Yt,
		Ae,
		Wa =
			'<img src="/images/stm32/low-res/stm32cubemx_project_manager.png" alt="STM32CubeMX project manager window"/>',
		jt,
		Me,
		Xa = 'GNU Arm embedded toolchain',
		Zt,
		Te,
		Ya = 'Windows',
		Kt,
		ze,
		ja =
			'The GNU embedded toolchain for Arm microcontrollers can be installed via the executable from <a href="https://developer.arm.com/tools-and-software/open-source-software/developer-tools/gnu-toolchain/gnu-rm/downloads" rel="nofollow">armDeveloper</a>. Alternatively, install via Chocolatey:',
		Jt,
		vt,
		es =
			'<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #ABB2BF">choco install gcc</span><span style="color: #56B6C2">-</span><span style="color: #ABB2BF">arm</span><span style="color: #56B6C2">-</span><span style="color: #ABB2BF">embedded</span></span></code></pre>',
		gt,
		Ce,
		Za = 'Linux',
		Qt,
		...
		xt,
		rs =
			'<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #61AFEF">brew</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">install</span><span style="color: #ABB2BF"> </span><span style="color: #D19A66">--cask</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">gcc-arm-embedded</span></span></code></pre>',
		wt,
		Fe,
		Ja = 'OpenOCD',
		tr,
		...
		Bt,
		as =
			'<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #ABB2BF">choco install openocd</span></span></code></pre>',
		kt,
		Ie,
		tn = 'Linux',
		nr,
		St,
		ns =
			'<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #61AFEF">sudo</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">apt</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">install</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">openocd</span></span></code></pre>',
		At,
		qe,
		rn = 'macOS',
		sr,
		Mt,
		ss =
			'<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #61AFEF">brew</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">install</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">openocd</span></span></code></pre>',
		Tt,
		He,
		an = 'JetBrains CLion IDE',
		lr,
		Re,
		nn =
		...
		Le,
		sn =
			'A complete guide to configuring CLion for STM32 can be found at <a href="https://www.jetbrains.com/help/clion/embedded-development.html" rel="nofollow">STM32CubeMX projects</a>. Once you have installed the compiler toolchain and dependencies, and configured the IDE, you are ready to begin development!',
		or,
		Oe,
		ur,
		Pe,
		ln =
			'With the default pin configuration, we have access to the onboard green LED (LD2) via GPIO PA5. To blink the LED, we need to modify the <code>Core/Src/main.c</code> file, specifically calling the pin toggle function in the infinite loop:',
		hr,
		zt,
		ls = `<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">/* Infinite loop */</span></span>
...
<span class="line"><span style="color: #7F848E; font-style: italic">/* USER CODE END 3 */</span></span></code></pre>`,
		Ct,
		Ge,
		on =
		...
		Ve,
		hn =
			'To begin, we have to contigure the pinout for <strong>USART1</strong>, which stands for “Universal Synchronous Asynchronous Receiver Transmitter.”',
		dr,
		_e,
		mn =
			'<img src="/images/stm32/low-res/stm32cubemx_serial_interrupt_config.png" alt="STM32CubeMX serial interrupt configuration"/>',
		fr,
		We,
		cn =
		...
		vr,
		Dt,
		is = `<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #7F848E; font-style: italic">/*</span></span>
...
<span class="line"><span style="color: #ABB2BF">&#125;</span></span></code></pre>`,
		...
		xr,
		Ke,
		vn = 'Calculating the lookup table',
		wr,
		D0,
		Kr,
		Je,
		...
		Br,
		Et,
		os = `<pre class="shiki one-dark-pro" style="background-color: #282c34" tabindex="0"><code><span class="line"><span style="color: #C678DD">#include</span><span style="color: #ABB2BF"> </span><span style="color: #98C379">&lt;stdint.h&gt;</span></span>
...
<span class="line"><span style="color: #ABB2BF">&#125;</span></span></code></pre>`,
		...
		Ar
	return (
		(y = new It({ props: { str: 'Introduction' } })),
		(D = new yn({
			props: {
				msg: 'All tutorials in this guide refer to the STM32 <a href="https://www.st.com/en/evaluation-tools/nucleo-g431rb.html">Nucleo-G431RB</a> development board. We will also use the JetBrains CLion IDE instead of the STM32CubeIDE for all development. Source code for the tutorials may be found at <a href="https://github.com/lukasvasadi/stm32-tutorial-source">github.com/lukasvasadi/stm32-tutorial-source</a>.'
			}
		})),
		(v0 = new yn({
			props: {
				msg: 'Even though the STM32 platform requires a deeper understanding of hardware development, I have found that programming more advanced features, such as interrupts, is easier than Arduino.'
			}
		})),
		(B0 = new It({ props: { str: 'Setup' } })),
		(Oe = new It({ props: { str: 'Blink' } })),
		($e = new It({ props: { str: 'Serial communication with interrupts' } })),
		(Xe = new It({ props: { str: 'Analog waveform generator' } })),
		(Je = new qt({ props: { expr: 'V', mode: 'inline' } })),
		(Qe = new qt({ props: { expr: 'N', mode: 'inline' } })),
		(et = new qt({ props: { expr: 'R', mode: 'inline' } })),
		(rt = new qt({ props: { expr: pi } })),
		(at = new qt({ props: { expr: di } })),
		{
			c() {
				;(e = V('p')),
					(e.innerHTML = t),
					...
					(D0 = V('p')),
					(Kr = Tr(
						'Below is a source code snippet that can be integrated into the MCU startup routine. It calculates an output voltage level, '
					)),
					F0(Je.$$.fragment),
					(Jr = Tr(', based on the number of samples, ')),
					F0(Qe.$$.fragment),
					(Qr = Tr(', and DAC resolution, ')),
					F0(et.$$.fragment),
					(ea = Tr('.')),
					(Br = H()),
					(Et = new _0(!1)),
			...
			l(p) {
				;(e = _(p, 'P', { 'data-svelte-h': !0 })),
					W(e) !== 'svelte-1nc9l3p' && (e.innerHTML = t),
					(a = R(p)),
					(n = _(p, 'H2', { 'data-svelte-h': !0 })),
					W(n) !== 'svelte-jpxk5s' && (n.textContent = l),
					(o = R(p)),
					(h = _(p, 'UL', { 'data-svelte-h': !0 })),
					W(h) !== 'svelte-tmpzqw' && (h.innerHTML = m),
					(v = R(p)),
					E0(y.$$.fragment, p),
					(b = R(p)),
					(B = _(p, 'P', { 'data-svelte-h': !0 })),
					W(B) !== 'svelte-51q131' && (B.innerHTML = k),
					(C = R(p)),
					E0(D.$$.fragment, p),
					(I = R(p)),
					(N = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(N) !== 'svelte-1ox5jh7' && (N.textContent = P),
					(U = R(p)),
					(Z = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Z) !== 'svelte-kyw9z5' && (Z.innerHTML = Y),
					(K = R(p)),
					(j = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(j) !== 'svelte-pglehj' && (j.textContent = t0),
					(J = R(p)),
					(c0 = _(p, 'P', { 'data-svelte-h': !0 })),
					W(c0) !== 'svelte-ff6dr3' && (c0.textContent = m0),
					(a0 = R(p)),
					(y0 = _(p, 'P', { 'data-svelte-h': !0 })),
					W(y0) !== 'svelte-1vmdeoa' && (y0.textContent = p0),
					(f0 = R(p)),
					E0(v0.$$.fragment, p),
					(G0 = R(p)),
					E0(B0.$$.fragment, p),
					(ce = R(p)),
					(g0 = _(p, 'P', { 'data-svelte-h': !0 })),
					W(g0) !== 'svelte-1n5c3d4' && (g0.textContent = $0),
					(d0 = R(p)),
					(A0 = _(p, 'UL', { 'data-svelte-h': !0 })),
					W(A0) !== 'svelte-1c7wpuy' && (A0.innerHTML = it),
					(U0 = R(p)),
					(Y0 = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(Y0) !== 'svelte-11sfqkb' && (Y0.textContent = re),
					(V0 = R(p)),
					(z0 = _(p, 'P', { 'data-svelte-h': !0 })),
					W(z0) !== 'svelte-112j9av' && (z0.innerHTML = Be),
					(ot = R(p)),
					(ae = _(p, 'P', { 'data-svelte-h': !0 })),
					W(ae) !== 'svelte-jlhsy0' && (ae.textContent = Wt),
					(pe = R(p)),
					(j0 = _(p, 'P', { 'data-svelte-h': !0 })),
					W(j0) !== 'svelte-1sh19qn' && (j0.innerHTML = ft),
					(de = R(p)),
					(C0 = _(p, 'P', { 'data-svelte-h': !0 })),
					W(C0) !== 'svelte-63amuw' && (C0.textContent = ke),
					(Xt = R(p)),
					(Se = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Se) !== 'svelte-ser4xf' && (Se.innerHTML = _a),
					(Yt = R(p)),
					(Ae = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ae) !== 'svelte-im8w8h' && (Ae.innerHTML = Wa),
					(jt = R(p)),
					(Me = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(Me) !== 'svelte-17a8ahz' && (Me.textContent = Xa),
					(Zt = R(p)),
					(Te = _(p, 'H4', { 'data-svelte-h': !0 })),
					W(Te) !== 'svelte-a506pd' && (Te.textContent = Ya),
					(Kt = R(p)),
					(ze = _(p, 'P', { 'data-svelte-h': !0 })),
					W(ze) !== 'svelte-8r6mlz' && (ze.innerHTML = ja),
					(Jt = R(p)),
					(vt = W0(p, !1)),
					(gt = R(p)),
					(Ce = _(p, 'H4', { 'data-svelte-h': !0 })),
					W(Ce) !== 'svelte-dikflg' && (Ce.textContent = Za),
					(Qt = R(p)),
					(yt = W0(p, !1)),
					(bt = R(p)),
					(De = _(p, 'H4', { 'data-svelte-h': !0 })),
					W(De) !== 'svelte-1f4vatt' && (De.textContent = Ka),
					(er = R(p)),
					(xt = W0(p, !1)),
					(wt = R(p)),
					(Fe = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(Fe) !== 'svelte-1o7e2pg' && (Fe.textContent = Ja),
					(tr = R(p)),
					(Ee = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ee) !== 'svelte-rsanli' && (Ee.textContent = Qa),
					(rr = R(p)),
					(Ne = _(p, 'H4', { 'data-svelte-h': !0 })),
					W(Ne) !== 'svelte-a506pd' && (Ne.textContent = en),
					(ar = R(p)),
					(Bt = W0(p, !1)),
					(kt = R(p)),
					(Ie = _(p, 'H4', { 'data-svelte-h': !0 })),
					W(Ie) !== 'svelte-dikflg' && (Ie.textContent = tn),
					(nr = R(p)),
					(St = W0(p, !1)),
					(At = R(p)),
					(qe = _(p, 'H4', { 'data-svelte-h': !0 })),
					W(qe) !== 'svelte-1f4vatt' && (qe.textContent = rn),
					(sr = R(p)),
					(Mt = W0(p, !1)),
					(Tt = R(p)),
					(He = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(He) !== 'svelte-168lvrd' && (He.textContent = an),
					(lr = R(p)),
					(Re = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Re) !== 'svelte-1foz4h8' && (Re.innerHTML = nn),
					(ir = R(p)),
					(Le = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Le) !== 'svelte-13xxkx3' && (Le.innerHTML = sn),
					(or = R(p)),
					E0(Oe.$$.fragment, p),
					(ur = R(p)),
					(Pe = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Pe) !== 'svelte-hvt1hj' && (Pe.innerHTML = ln),
					(hr = R(p)),
					(zt = W0(p, !1)),
					(Ct = R(p)),
					(Ge = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ge) !== 'svelte-1ng9gzr' && (Ge.textContent = on),
					(mr = R(p)),
					E0($e.$$.fragment, p),
					(cr = R(p)),
					(Ue = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ue) !== 'svelte-1rlx8nk' && (Ue.textContent = un),
					(pr = R(p)),
					(Ve = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ve) !== 'svelte-1gk7j3t' && (Ve.innerHTML = hn),
					(dr = R(p)),
					(_e = _(p, 'P', { 'data-svelte-h': !0 })),
					W(_e) !== 'svelte-1kuitbu' && (_e.innerHTML = mn),
					(fr = R(p)),
					(We = _(p, 'P', { 'data-svelte-h': !0 })),
					W(We) !== 'svelte-15zrrup' && (We.textContent = cn),
					(vr = R(p)),
					(Dt = W0(p, !1)),
					(Ft = R(p)),
					E0(Xe.$$.fragment, p),
					(gr = R(p)),
					(Ye = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ye) !== 'svelte-1r9jgoj' && (Ye.textContent = pn),
					(yr = R(p)),
					(je = _(p, 'P', { 'data-svelte-h': !0 })),
					W(je) !== 'svelte-5rjoba' && (je.textContent = dn),
					(br = R(p)),
					(Ze = _(p, 'P', { 'data-svelte-h': !0 })),
					W(Ze) !== 'svelte-1mq6x7p' && (Ze.textContent = fn),
					(xr = R(p)),
					(Ke = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(Ke) !== 'svelte-y0coh2' && (Ke.textContent = vn),
					(wr = R(p)),
					(D0 = _(p, 'P', {}))
				var w = hs(D0)
				;(Kr = zr(
					...
					E0(Je.$$.fragment, w),
					(Jr = zr(w, ', based on the number of samples, ')),
					E0(Qe.$$.fragment, w),
					(Qr = zr(w, ', and DAC resolution, ')),
					E0(et.$$.fragment, w),
					(ea = zr(w, '.')),
					w.forEach(S),
					(Br = R(p)),
					(Et = W0(p, !1)),
					(Nt = R(p)),
					(tt = _(p, 'H3', { 'data-svelte-h': !0 })),
					W(tt) !== 'svelte-161aj6p' && (tt.textContent = gn),
					(kr = R(p)),
					E0(rt.$$.fragment, p),
					(Sr = R(p)),
					E0(at.$$.fragment, p),
...
const bi = {
		...
		categories: ['STM32', 'Microcontrollers', 'Interrupts', 'Serial', 'DAC'],
		published: !0
	},
	pi = 'f_t=\\frac{f_{clk}}{(PSC+1)(ARR+1)}',
	di = 'f_o=\\frac{f_t}{n}'
class xi extends r1 {
	constructor(e) {
		super(), a1(this, e, null, ci, t1, {})
	}
}
export { xi as default, bi as metadata }
