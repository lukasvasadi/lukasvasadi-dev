import { c as create_ssr_component, v as validate_component, e as escape, a as subscribe } from "../../chunks/ssr.js";
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `<div class="layout svelte-sdkn5t"> ${validate_component(Header, "Header").$$render($$result, {}, {}, {})} <main class="svelte-sdkn5t"> ${validate_component(Transition, "PageTransition").$$render($$result, { url: data.url }, {}, {
    default: () => {
      return `${slots.default ? slots.default({}) : ``}`;
    }
